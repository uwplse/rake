...
(define (compile arm-expr)
  (match arm-expr
    ...
    [(arm:uzip1 Vn Vm)
      ;; There are no intrinsics for zips
      `(halide.ir.deinterleave_even, (to-llvm-type arm-expr), `(list ,(input-arg Vn) ,(input-arg Vm)))]

    [(arm:uzip2 Vn Vm)
      ;; There are no intrinsics for zips
      `(halide.ir.deinterleave_odd, (to-llvm-type arm-expr), `(list ,(input-arg Vn) ,(input-arg Vm)))]
