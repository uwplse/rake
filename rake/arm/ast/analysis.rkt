...
(define (max-unique-inputs expr)
  (destruct expr
    ...
    [(arm:mla-vs Vd Vn Vm) (+ (max-unique-inputs Vd) (max-unique-inputs Vn))]
    [(arm:mla-vv Vd Vn Vm) (+ (max-unique-inputs Vd) (max-unique-inputs Vn) (max-unique-inputs Vm))]
    [(arm:mls-vs Vd Vn Vm) (+ (max-unique-inputs Vd) (max-unique-inputs Vn))]
    ...
    [(arm:sqdmull-vs Vn Vm) (+ (max-unique-inputs Vn))]
