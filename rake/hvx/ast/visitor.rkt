...
(define (visit p transform)
  (match p
    ...
    [(vpacko_2 Vu Vv signed?) (transform (vpacko_2 (visit Vu transform) (visit Vv transform) (visit signed? transform)))]
    [(vshuffo_2 Vu Vv signed?) (transform (vshuffo_2 (visit Vu transform) (visit Vv transform) (visit signed? transform)))]
