...
(define (visit p transform [arg-pos -1])
  ...
  (define outp
    (match p
      ...
      [(vmpy-hh Vd Rt rnd?) (transform (vmpy-hh (visit Vd transform) (visit Rt transform) (visit rnd? transform)))]
...
(define (visit-shallow p transform [arg-pos -1])
  ...
  (define outp
    (match p
      ...
      [(vmpy-hh Vd Rt rnd?) (transform (vmpy-hh (visit-shallow Vd transform) (visit-shallow Rt transform) (visit-shallow rnd? transform)))]
