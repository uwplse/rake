  ...
  (match p
    ...
    [(vcombine Vu Vv)
     (match (list (interpret-hvx Vu) (interpret-hvx Vv))
       [(list (i8x128 _) (i8x128 _)) (generate `vcombine `64xi32 `(list (32xi32 ,(codegen Vu)) (32xi32 ,(codegen Vv))))]
       [(list (u8x128 _) (u8x128 _)) (generate `vcombine `64xi32 `(list (32xi32 ,(codegen Vu)) (32xi32 ,(codegen Vv))))]
       [(list (i16x64 _) (i16x64 _)) (generate `vcombine `64xi32 `(list (32xi32 ,(codegen Vu)) (32xi32 ,(codegen Vv))))]
       [(list (u16x64 _) (u16x64 _)) (generate `vcombine `64xi32 `(list (32xi32 ,(codegen Vu)) (32xi32 ,(codegen Vv))))]
       [(list (i32x32 _) (i32x32 _)) (generate `vcombine `64xi32 `(list (32xi32 ,(codegen Vu)) (32xi32 ,(codegen Vv))))]
       [(list (u32x32 _) (u32x32 _)) (generate `vcombine `64xi32 `(list (32xi32 ,(codegen Vu)) (32xi32 ,(codegen Vv))))])]
    ...
    [(vshuff Vu)
     (match (interpret-hvx Vu)
       [(i8x128 _) (generate `vshuffb `32xi32 `(32xi32 ,(codegen Vu)))]
       [(u8x128 _) (generate `vshuffb `32xi32 `(32xi32 ,(codegen Vu)))]
       [(i16x64 _) (generate `vshuffh `32xi32 `(32xi32 ,(codegen Vu)))]
       [(u16x64 _) (generate `vshuffh `32xi32 `(32xi32 ,(codegen Vu)))])]
    ...
    [(vmpy-acc Vdd Vu Rt)
     (match (list (interpret-hvx Vdd) (interpret-hvx Vu) (interpret-hvx Rt))
       [(list (i16x64x2 _ _) (u8x128 _) (int8_t _))
        (generate `vmpybus.acc `64xi32 `(list (64xi32 ,(codegen Vdd)) (32xi32 ,(codegen Vu)) (i32 ,(codegen-scalar Rt))))]
       [(list (u16x64x2 _ _) (u8x128 _) (uint8_t _))
        (generate `vmpyub.acc `64xi32 `(list (64xi32 ,(codegen Vdd)) (32xi32 ,(codegen Vu)) (i32 ,(codegen-scalar Rt))))]
       ;; todo:
    ...
    [(vmpa Vuu Rt)
     (match (list (interpret-hvx Vuu) (interpret-hvx Rt))
       [(list (u8x128x2 _ _) (cons (int8_t _) (int8_t _)))
        (generate `vmpabus `32xi32 `(list (64xi32 ,(codegen Vuu)) (i32 ,(codegen-scalar Rt))))]
       [(list (u8x128x2 _ _) (cons (uint8_t _) (uint8_t _)))
        (generate `vmpabuu `32xi32 `(list (64xi32 ,(codegen Vuu)) (i32 ,(codegen-scalar Rt))))]
       [(list (u16x64x2 _ _) (cons (int8_t _) (int8_t _)))
        (generate `vmpauhb `32xi32 `(list (64xi32 ,(codegen Vuu)) (i32 ,(codegen-scalar Rt))))]
       [(list (i16x64x2 _ _) (cons (int8_t _) (int8_t _)))
        (generate `vmpahb `32xi32 `(list (64xi32 ,(codegen Vuu)) (i32 ,(codegen-scalar Rt))))])]
    
    ;;vmpa-acc
    [(vmpa-acc Vdd Vuu Rt)
     (match (list (interpret-hvx Vdd) (interpret-hvx Vuu) (interpret-hvx Rt))
       [(list (i16x64x2 _ _) (u8x128x2 _ _) (cons (int8_t w1) (int8_t w2)))
        (generate `vmpabus.acc `64xi32 `(list (64xi32 ,(codegen Vdd)) (64xi32 ,(codegen Vuu)) (i32 ,(codegen-scalar Rt))))]
       [(list (i16x64x2 _ _) (u8x128x2 _ _) (cons (uint8_t w1) (uint8_t w2)))
        (generate `vmpabuu.acc `64xi32 `(list (64xi32 ,(codegen Vdd)) (64xi32 ,(codegen Vuu)) (i32 ,(codegen-scalar Rt))))]
       [(list (i32x32x2 _ _) (u16x64x2 _ _) (cons (int8_t w1) (int8_t w2)))
        (generate `vmpauhb.acc `64xi32 `(list (64xi32 ,(codegen Vdd)) (64xi32 ,(codegen Vuu)) (i32 ,(codegen-scalar Rt))))]
       [(list (i32x32x2 _ _) (i16x64x2 _ _) (cons (int8_t w1) (int8_t w2)))
        (generate `vmpahb.acc `64xi32 `(list (64xi32 ,(codegen Vdd)) (64xi32 ,(codegen Vuu)) (i32 ,(codegen-scalar Rt))))])]
