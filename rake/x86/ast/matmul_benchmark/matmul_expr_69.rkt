...
(require rake)
(init-logging "matmul_expr_69.runtimes")
...
(define-symbolic-var t5833 int32_t)
(define-symbolic-var t5834 int32_t)
(define-symbolic output.s0.x.x integer?)
(define-symbolic-var t6673 int32_t)
(define-symbolic t6636 integer?)
...
(define t6125 (var-lookup 't6125 (sca-sub  t6636  t6114)))
   ...
   (vec-add
    (vec-add
     ...
     (vec-add
      ...
      (x16 (sca-add (sca-mul (sca-mul t5833 t5834) mat_a.extent.0) (sca-mul t5834 t6673)))))
    (int32x16
     (load multiplied_no_offsets (ramp (sca-add (sca-add (sca-mul output.s0.x.x 16) t6125) 4) 1 16) (aligned 4 0)))))
  (int64x16
...
(llvm-codegen x86-expr "matmul_sexp_69.out")