...
(define t315 (var-lookup 't315 (sca-sub  (sca-sub  (sca-sub  (sca-sub  input.min.0  t453)  t454)  t455)  input.min.0)))
...
(define halide-expr
 (vec-max
  ...
  (load input (ramp (sca-add (sca-mul (sca-add maximum.s1.r$x.rebased t340) input.stride.1) t343) 1 16) (aligned 1 0))))

(define spec (synthesis-spec 'halide-ir halide-expr axioms))
(define x86-expr (synthesize-x86 spec 'greedy 'enumerative 'enumerative))

(llvm-codegen x86-expr "max_pool_sexp_4.out")