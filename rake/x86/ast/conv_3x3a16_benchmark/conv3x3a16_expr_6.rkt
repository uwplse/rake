...
(require rake)
(init-logging "conv3x3a16_expr_6.runtimes")
...
(define t47 (var-lookup 't47 (sca-add  output.s0.x.x  t122)))
(define t51 (var-lookup 't51 (sca-add  output.s0.x.x  t113)))
(define t81 (var-lookup 't81 (sca-add  output.s0.x.x  t120)))
    ...
    (vec-shr
     (vec-add
      (vec-mul
       (int16x16
        (uint16x16
         (load input_bounded (ramp (sca-add (sca-mul t51 16) 1) 1 16) (aligned 16 1))))
       (int16x16
      ...
      (vec-add
       (vec-mul
        (int16x16
         (uint16x16
          (load input_bounded (ramp (sca-mul t51 16) 1 16) (aligned 16 0))))
        (int16x16
       ...
       (vec-add
        (vec-mul
         (int16x16
          (uint16x16
           (load input_bounded (ramp (sca-add (sca-mul t51 16) 2) 1 16) (aligned 16 2))))
         (int16x16
        ...
        (vec-add
         (vec-mul
          (int16x16
           (uint16x16
            (load input_bounded (ramp (sca-mul t81 16) 1 16) (aligned 16 0))))
          (int16x16
         ...
         (vec-add
          (vec-mul
           (int16x16
            (uint16x16
             (load input_bounded (ramp (sca-add (sca-mul t81 16) 1) 1 16) (aligned 16 1))))
           (int16x16
          ...
          (vec-add
           (vec-mul
            (int16x16
             (uint16x16
              (load input_bounded (ramp (sca-add (sca-mul t81 16) 2) 1 16) (aligned 16 2))))
            (int16x16
           ...
           (vec-add
            (vec-mul
             (int16x16
              (uint16x16
               (load input_bounded (ramp (sca-mul t47 16) 1 16) (aligned 16 0))))
             (int16x16
            ...
            (vec-add
             (vec-mul
              (int16x16
               (uint16x16
                (load input_bounded (ramp (sca-add (sca-mul t47 16) 2) 1 16) (aligned 16 2))))
              (int16x16
               (x16 (load-sca mask (sca-add t92 2)))))
             (vec-mul
              (int16x16
               (uint16x16
                (load input_bounded (ramp (sca-add (sca-mul t47 16) 1) 1 16) (aligned 16 1))))
              (int16x16
...
(llvm-codegen x86-expr "conv3x3a16_sexp_6.out")