...
(require rake)
(init-logging "conv3x3a16_expr_5.runtimes")
...
(define t41 (var-lookup 't41 (sca-add  output.s0.x.x  t120)))
(define t45 (var-lookup 't45 (sca-add  output.s0.x.x  t115)))
(define t78 (var-lookup 't78 (sca-add  output.s0.x.x  t113)))
    ...
    (vec-shr
     (vec-add
      (vec-mul
       (int16x16
        (uint16x16
         (load input_bounded (ramp (sca-add (sca-mul t45 16) 1) 1 16) (aligned 16 1))))
       (int16x16
      ...
      (vec-add
       (vec-mul
        (int16x16
         (uint16x16
          (load input_bounded (ramp (sca-mul t45 16) 1 16) (aligned 16 0))))
        (int16x16
       ...
       (vec-add
        (vec-mul
         (int16x16
          (uint16x16
           (load input_bounded (ramp (sca-add (sca-mul t45 16) 2) 1 16) (aligned 16 2))))
         (int16x16
        ...
        (vec-add
         (vec-mul
          (int16x16
           (uint16x16
            (load input_bounded (ramp (sca-mul t78 16) 1 16) (aligned 16 0))))
          (int16x16
         ...
         (vec-add
          (vec-mul
           (int16x16
            (uint16x16
             (load input_bounded (ramp (sca-add (sca-mul t78 16) 1) 1 16) (aligned 16 1))))
           (int16x16
          ...
          (vec-add
           (vec-mul
            (int16x16
             (uint16x16
              (load input_bounded (ramp (sca-add (sca-mul t78 16) 2) 1 16) (aligned 16 2))))
            (int16x16
...
(llvm-codegen x86-expr "conv3x3a16_sexp_5.out")