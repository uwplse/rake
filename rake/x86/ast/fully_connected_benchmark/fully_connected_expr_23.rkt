...
(require rake)
(init-logging "fully_connected_expr_23.runtimes")

(define-symbolic-buffer bias int32_t)
(define-symbolic-var t843 int32_t)
(define-symbolic-var t844 int32_t)
...
(define halide-expr
 (vec-add
  ...
  (x4 (sca-sub t669 (sca-mul t843 t844)))))

(define spec (synthesis-spec 'halide-ir halide-expr axioms))
(define x86-expr (synthesize-x86 spec 'greedy 'enumerative 'enumerative))

(llvm-codegen x86-expr "fully_connected_sexp_23.out")