...
(require rake)
(init-logging "fully_connected_expr_31.runtimes")
 ...
 (vec-add
  (vector_reduce 'add 4
   (int32x16
    (vec-mul
     (uint16x16
      (load filter (ramp (sca-add (sca-mul multiplied_intm.s1.rc$x.rc$x.rco 16) t701) 1 16) (aligned 1 0)))
     (uint16x16
...
(llvm-codegen x86-expr "fully_connected_sexp_31.out")