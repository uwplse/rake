...
(require rake)
(init-logging "fully_connected_expr_15.runtimes")
  ...
  (vector_reduce 'add 4
   (int32x16
    (vec-mul
     ...
     (uint16x16
      (load input (ramp (sca-add (sca-mul multiplied_intm.s1.rc$x.rc$x.rco 16) t683) 1 16) (aligned 1 0))))))
  (load multiplied_intm (ramp 44 1 4) (aligned 0 44))))

(define spec (synthesis-spec 'halide-ir halide-expr axioms))
(define x86-expr (synthesize-x86 spec 'greedy 'enumerative 'enumerative))

(llvm-codegen x86-expr "fully_connected_sexp_15.out")