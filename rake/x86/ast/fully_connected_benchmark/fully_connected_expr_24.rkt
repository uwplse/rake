...
(require rake)
(init-logging "fully_connected_expr_24.runtimes")

(define-symbolic-buffer bias int32_t)
(define-symbolic-var t846 int32_t)
(define-symbolic-var t847 int32_t)
...
(define halide-expr
 (vec-add
  ...
  (x4 (sca-sub t669 (sca-mul t846 t847)))))

(define spec (synthesis-spec 'halide-ir halide-expr axioms))
(define x86-expr (synthesize-x86 spec 'greedy 'enumerative 'enumerative))

(llvm-codegen x86-expr "fully_connected_sexp_24.out")