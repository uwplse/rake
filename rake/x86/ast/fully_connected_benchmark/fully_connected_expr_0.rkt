...
(define-symbolic sum_input.s1.rc$x.rc$x integer?)
...
(define halide-expr
 (uint32x16
  (load input (ramp (sca-add (sca-mul sum_input.s1.rc$x.rc$x 16) t661) 1 16) (aligned 1 0))))

(define spec (synthesis-spec 'halide-ir halide-expr axioms))
(define x86-expr (synthesize-x86 spec 'greedy 'enumerative 'enumerative))

(llvm-codegen x86-expr "fully_connected_sexp_0.out")