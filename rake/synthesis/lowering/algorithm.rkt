...
;(define (synthesize-arm-template halide-expr ir-expr arm-sub-exprs output-layout value-bounds translation-history lowering-algo cost-ub)
;  (cond
;    [(eq? lowering-algo 'enumerative)
...
;      (display (format "IR Operation: \n\n~a\n\n" (pretty-format ir-expr)))
;
;      (define candidates (get-arm-grammar halide-expr ir-expr arm-sub-exprs output-layout cost-ub))
;      
