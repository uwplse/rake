...
(require (only-in racket/base values make-hash hash-set!)
         ...
         rake/synthesis/lifting/hvx/util)

(provide synthesize-hvx-translation (rename-out [get-lifted-expr-bounds get-lifted-hvx-expr-bounds]))
...
(define (synthesize-hvx-translation templates halide-expr axioms context equiv-fn)
  (cond
    ...
    [else
     ...
     (cond
       ...
       [else
        (synthesize-hvx-translation (rest templates) halide-expr axioms context equiv-fn)])]))
