...
(define (verification-lanes type)
  (cond
    [(eq? type 'Qt8) '(0 1 2 63 64 65 127)]
    [(eq? type 'Qt16) '(0 1 2 31 32 33 63)]
    [(eq? type 'Qt32) '(0 1 2 15 16 17 31)]
    [(eq? type 'i8x128) '(0 1 2 63 64 65 127)]
    [(eq? type 'u8x128) '(0 1 2 63 64 65 127)]
    [(eq? type 'i16x64) '(0 1 2 31 32 33 63)]
    [(eq? type 'u16x64) '(0 1 2 31 32 33 63)]
    [(eq? type 'i32x32) '(0 1 2 15 16 17 31)]
    [(eq? type 'u32x32) '(0 1 2 15 16 17 31)]
    [(eq? type 'i8x128x2) '(0 1 2 63 64 127 128 129 191 192 255)]
    [(eq? type 'u8x128x2) '(0 1 2 63 64 127 128 129 191 192 255)]
    [(eq? type 'i16x64x2) '(0 1 2 31 32 63 64 65 95 96 127)]
    [(eq? type 'u16x64x2) '(0 1 2 31 32 63 64 65 95 96 127)]
