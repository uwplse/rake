#ifndef HALIDE_____bin___host___basic8_h
#define HALIDE_____bin___host___basic8_h
#include <stdint.h>
...
int basic8(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int basic8_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *basic8_metadata() HALIDE_FUNCTION_ATTRS;
