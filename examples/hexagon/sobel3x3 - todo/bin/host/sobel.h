#ifndef HALIDE_____bin___host___sobel_h
#define HALIDE_____bin___host___sobel_h
#include <stdint.h>
...
int sobel(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int sobel_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *sobel_metadata() HALIDE_FUNCTION_ATTRS;
