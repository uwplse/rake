...
declare i32 @llvm.hexagon.S2.vsplatrh(i32)
...
define weak_odr i32 @halide.hexagon.pack2.h(i16 %arg1, i16 %arg0) nounwind uwtable readnone alwaysinline {
  %arg0_i32 = zext i16 %arg0 to i32
  %arg1_i32 = zext i16 %arg1 to i32
  %arg1_i32_s = shl i32 %arg1_i32, 16
  %r = or i32 %arg1_i32_s, %arg0_i32
  ret i32 %r
}
