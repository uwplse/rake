...
| 10 |                 | expr_5.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
...
| 84 |                 | expr_1.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 85 |                 | expr_2.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 86 |                 | expr_3.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 87 |                 | expr_4.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 88 |                 | expr_5.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 89 |                 | expr_6.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 90 |                 | expr_7.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 91 |                 | expr_8.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 92 | matmul          | expr_0.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 93 |                 | expr_1.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 94 |                 | expr_2.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 95 |                 | expr_3.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 96 |                 | expr_4.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 97 |                 | expr_5.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 98 |                 | expr_6.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 99 |                 | expr_7.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 100 |                | expr_8.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 101 |                | expr_9.rkt  | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 102 |                | expr_10.rkt | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 103 |                | expr_11.rkt | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 104 |                | expr_12.rkt | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 105 |                | expr_13.rkt | :heavy_check_mark: | :x:           | :x:                      | :x:       |
| 106 |                | expr_14.rkt | :heavy_check_mark: | :x:           | :x:                      | :x:       |
