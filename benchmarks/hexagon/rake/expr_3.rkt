#lang rosette
; uint8x128((int16x128)rounding_shift_right((((int16x128((uint8x128)input[ramp(t15 + 1, 1, 128)])*x128((int16)2)) + (((((((int16x128((uint8x128)input[ramp(t15, 1, 128)])*x128((int16)2)) + int16x128((uint8x128)input[ramp((input.stride.1*-1) + t15, 1, 128)])) + int16x128((uint8x128)input[ramp(input.stride.1 + t15, 1, 128)])) + int16x128((uint8x128)input[ramp(t15 + -1, 1, 128)]))*x128((int16)2)) + int16x128((uint8x128)input[ramp(((input.stride.1*-1) + t15) + -1, 1, 128)])) + int16x128((uint8x128)input[ramp((input.stride.1 + t15) + -1, 1, 128)]))) + int16x128((uint8x128)input[ramp(((input.stride.1*-1) + t15) + 1, 1, 128)])) + int16x128((uint8x128)input[ramp((input.stride.1 + t15) + 1, 1, 128)]), x128((uint16)4)))
...
(define-symbolic t83 integer?)

(define axioms 
  (list ))

(define input.stride.1 t46)
(define t15 (+   (*    output.s0.x.x    128)   t83))
