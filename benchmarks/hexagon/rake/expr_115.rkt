...
(require rake)
(init-logging "expr_115.runtimes")
...
(define-symbolic t1767 integer?)
(define-symbolic t1768 integer?)
...
(define t1118.s (var-lookup 't1118.s (sca-add  t1768  t1767)))
  ...
  (vector_reduce 'add 4
   (int32x128
    (vec-mul
     (uint16x128
      (vec-broadcast 32
       (load input (ramp (sca-add (sca-mul convolved.s1.r19$z.r124 4) (sca-add (sca-mul input.stride.1 t1118.s) t1108)) 1 4) (aligned 4 0))))
     (uint16x128
...
(llvm-codegen hvx-expr "sexp_115.out")