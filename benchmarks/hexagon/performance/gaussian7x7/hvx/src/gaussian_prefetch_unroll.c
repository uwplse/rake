    ...
    )
{
    ...
    HVX_Vector sLine0, sLine1, sLine2, sLine3, sLine4, sLine5, sLine6, sLine7;
    HVX_Vector sVsum0, sVsum1, sVsum2, sVsum3, sVsum4, sVsum5;
    HVX_Vector sVsum1a3, sVsum2a4, sSumE, sSumO;

    HVX_VectorPair dVsumv0_0, dVsumv1_0, dVsumv2_0;
    HVX_VectorPair dVsumv0_1, dVsumv1_1, dVsumv2_1;
    HVX_VectorPair dVsumv0_2, dVsumv1_2, dVsumv2_2;
    HVX_VectorPair dVsumv0_3, dVsumv1_3, dVsumv2_3;
    ...
    HVX_Vector *iptr5 = (HVX_Vector *)(src + 3*stride);
    HVX_Vector *iptr6 = (HVX_Vector *)(src + 4*stride);
    HVX_Vector *iptr7 = (HVX_Vector *)(src + 5*stride);

    HVX_Vector *optr0 = (HVX_Vector *)(dst           );
    ...
    dVsumv0_0 = Q6_W_vcombine_VV(Q6_V_vzero(),Q6_V_vzero());
    dVsumv1_0 = dVsumv0_0;

    dVsumv0_1 = Q6_W_vcombine_VV(Q6_V_vzero(),Q6_V_vzero());
    dVsumv1_1 = dVsumv0_1;

    dVsumv0_2 = Q6_W_vcombine_VV(Q6_V_vzero(),Q6_V_vzero());
    dVsumv1_2 = dVsumv0_2;

    dVsumv0_3 = Q6_W_vcombine_VV(Q6_V_vzero(),Q6_V_vzero());
    dVsumv1_3 = dVsumv0_3;
    ...
    dVsumv2_0 = Q6_Wh_vadd_VubVub(sLine0,sLine4);
    dVsumv2_0 = Q6_Wh_vmpyacc_WhVubRb(dVsumv2_0,sLine2,const6);
    dVsumv2_0 = Q6_Wh_vmpaacc_WhWubRb(dVsumv2_0,Q6_W_vcombine_VV(sLine3,sLine1),const4);

    dVsumv2_1 = Q6_Wh_vadd_VubVub(sLine1,sLine5);
    dVsumv2_1 = Q6_Wh_vmpyacc_WhVubRb(dVsumv2_1,sLine3,const6);
    dVsumv2_1 = Q6_Wh_vmpaacc_WhWubRb(dVsumv2_1,Q6_W_vcombine_VV(sLine4,sLine2),const4);

    dVsumv2_2 = Q6_Wh_vadd_VubVub(sLine2,sLine6);
    dVsumv2_2 = Q6_Wh_vmpyacc_WhVubRb(dVsumv2_2,sLine4,const6);
    dVsumv2_2 = Q6_Wh_vmpaacc_WhWubRb(dVsumv2_2,Q6_W_vcombine_VV(sLine5,sLine3),const4);

    dVsumv2_3 = Q6_Wh_vadd_VubVub(sLine3,sLine7);
    dVsumv2_3 = Q6_Wh_vmpyacc_WhVubRb(dVsumv2_3,sLine5,const6);
    dVsumv2_3 = Q6_Wh_vmpaacc_WhWubRb(dVsumv2_3,Q6_W_vcombine_VV(sLine6,sLine4),const4);
    ...
    for ( i=width; i>VLEN; i-=VLEN)
    {
        ...
        sVsum0 = Q6_V_vlalign_VVI(Q6_V_lo_W(dVsumv1_0),Q6_V_lo_W(dVsumv0_0),2);
        sVsum1 = Q6_V_vlalign_VVI(Q6_V_hi_W(dVsumv1_0),Q6_V_hi_W(dVsumv0_0),2);
        sVsum2 = Q6_V_lo_W(dVsumv1_0);
        sVsum3 = Q6_V_hi_W(dVsumv1_0);
        sVsum4 = Q6_V_valign_VVI(Q6_V_lo_W(dVsumv2_0),Q6_V_lo_W(dVsumv1_0),2);
        sVsum5 = Q6_V_valign_VVI(Q6_V_hi_W(dVsumv2_0),Q6_V_hi_W(dVsumv1_0),2);
        ...
        *optr0++ = Q6_Vb_vshuffo_VbVb(sSumO,sSumE);
        ...
        sVsum0 = Q6_V_vlalign_VVI(Q6_V_lo_W(dVsumv1_1),Q6_V_lo_W(dVsumv0_1),2);
        sVsum1 = Q6_V_vlalign_VVI(Q6_V_hi_W(dVsumv1_1),Q6_V_hi_W(dVsumv0_1),2);
        sVsum2 = Q6_V_lo_W(dVsumv1_1);
        sVsum3 = Q6_V_hi_W(dVsumv1_1);
        sVsum4 = Q6_V_valign_VVI(Q6_V_lo_W(dVsumv2_1),Q6_V_lo_W(dVsumv1_1),2);
        sVsum5 = Q6_V_valign_VVI(Q6_V_hi_W(dVsumv2_1),Q6_V_hi_W(dVsumv1_1),2);
        ...
        *optr1++ = Q6_Vb_vshuffo_VbVb(sSumO,sSumE);
        ...
        sVsum0 = Q6_V_vlalign_VVI(Q6_V_lo_W(dVsumv1_2),Q6_V_lo_W(dVsumv0_2),2);
        sVsum1 = Q6_V_vlalign_VVI(Q6_V_hi_W(dVsumv1_2),Q6_V_hi_W(dVsumv0_2),2);
        sVsum2 = Q6_V_lo_W(dVsumv1_2);
        sVsum3 = Q6_V_hi_W(dVsumv1_2);
        sVsum4 = Q6_V_valign_VVI(Q6_V_lo_W(dVsumv2_2),Q6_V_lo_W(dVsumv1_2),2);
        sVsum5 = Q6_V_valign_VVI(Q6_V_hi_W(dVsumv2_2),Q6_V_hi_W(dVsumv1_2),2);
        ...
        *optr2++ = Q6_Vb_vshuffo_VbVb(sSumO,sSumE);
        ...
        sVsum0 = Q6_V_vlalign_VVI(Q6_V_lo_W(dVsumv1_3),Q6_V_lo_W(dVsumv0_3),2);
        sVsum1 = Q6_V_vlalign_VVI(Q6_V_hi_W(dVsumv1_3),Q6_V_hi_W(dVsumv0_3),2);
        sVsum2 = Q6_V_lo_W(dVsumv1_3);
        sVsum3 = Q6_V_hi_W(dVsumv1_3);
        sVsum4 = Q6_V_valign_VVI(Q6_V_lo_W(dVsumv2_3),Q6_V_lo_W(dVsumv1_3),2);
        sVsum5 = Q6_V_valign_VVI(Q6_V_hi_W(dVsumv2_3),Q6_V_hi_W(dVsumv1_3),2);
        ...
        *optr3++ = Q6_Vb_vshuffo_VbVb(sSumO,sSumE);
    }
