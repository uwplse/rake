...
.Lfunc_end119:
	.size	_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv, .Lfunc_end119-_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv
                                        // -- End function
	.section	.text.gaussian3x3_hvx64,"ax",@progbits
	.globl	gaussian3x3_hvx64       // -- Begin function gaussian3x3_hvx64
	.balign 32
	.type	gaussian3x3_hvx64,@function
gaussian3x3_hvx64:                      // @gaussian3x3_hvx64
// %bb.0:                               // %entry
	{
		allocframe(r29,#2304):raw
	}
	{
		r17:16 = combine(r0,r1)
		r29 = and(r29,#-128)
...
// %bb.1:                               // %entry
	...
	{
		r3 = memw(r2+#20)
		if (!cmp.gt(r3.new,#0)) jump:nt ##.LBB120_79
	}
...
.LBB120_4:                              // %after_bb
	...
	{
		p1 = cmp.eq(r0,#0); if (!p1.new) jump:t .LBB120_76
	}
	{
		jump .LBB120_77
	}
...
// %bb.6:                               // %"for output.s0.y.yi"
	...
	}                               // 4-byte Folded Spill
	{
		...
		if (p0.new) r5:4 = combine(r22,r19)
		memw(r29+#120) = r0
	}                               // 4-byte Folded Spill
...
.LBB120_9:                              //   in Loop: Header=BB120_5 Depth=2
	...
	{
		p0 = r2
		if (!p0.new) jump:nt .LBB120_76
		if (p0.new) r3 = memw(r29+#76)
		if (p0.new) r19 = memw(r29+#120)
	}                               // 4-byte Folded Reload
// %bb.10:                              // %true_bb
                                        //   in Loop: Header=BB120_5 Depth=2
	{
...
.LBB120_11:                             // %"for output.s0.x.x"
	...
	{
		r2 = memh(r29+#2046)
		memw(r29+#1468) = r2.new
	}
	{
		r2 = memh(r29+##2174)
		memw(r29+#1464) = r2.new
	}
	{
		r2 = memh(r29+#2044)
	...
	{
		r2 = memh(r29+#2042)
		memw(r29+#1216) = r2.new
	}
	{
		r2 = memh(r29+##2170)
		memw(r29+#1212) = r2.new
	}
	{
		r2 = memh(r29+#2040)
...
// %bb.43:                              // %"for output.s0.x.x"
                                        //   in Loop: Header=BB120_11 Depth=3
	{
		r2 = combine(r0.l,r16.l)
		r3 = memh(r29+#1982)
		memw(r29+#1468) = r3.new
	}
	{
		r3 = memh(r29+##2110)
		memw(r29+#1464) = r3.new
	}
	{
		r3 = memh(r29+#1980)
		memw(r29+#1344) = r3.new
	}
	{
		r3 = memh(r29+##2108)
		memw(r29+#1340) = r3.new
	}
	{
		r3 = memh(r29+#1978)
		memw(r29+#1212) = r3.new
	}
	{
		r3 = memh(r29+##2106)
		memw(r29+#1088) = r3.new
	}
	{
		r3 = memh(r29+#1976)
		memw(r29+#1024) = r3.new
	}
	{
		r3 = memh(r29+##2104)
		memw(r29+#1020) = r3.new
	}
	{
		r3 = memh(r29+#1974)
		memw(r29+#1016) = r3.new
	}
	{
		r3 = memh(r29+##2102)
		memw(r29+#896) = r3.new
...
// %bb.75:                              // %"for output.s0.x.x"
	...
	{
		r3 = add(r3,#-1)
		v29.h = vasr(v28.h,r21)
		v14 = vor(v0,v13)
		v0 = vmem(r6+#0)
	}                               // 128-byte Folded Reload
	{
		p1 = cmp.eq(r3,#0)
		v30.h = vasr(v27.h,r21)
		v22 = vnot(v29)
		v1 = vmem(r1+#0)
	}                               // 128-byte Folded Reload
	{
	...
	{
		v16.h = vasr(v18.h,r21)
	}
	{
		v17.h = vasr(v19.h,r21)
		v20 = vand(v16,v29)
		v22 = vand(v16,v22)
	}
	{
...
.LBB120_76:                             // %if.then.i
	...
	.falign
.LBB120_77:                             // %call_destructor.exit
                                        //   in Loop: Header=BB120_5 Depth=2
	{
		r16 = ##16908546
		r3 = memw(r29+#116)
...
// %bb.78:                              // %"end for output.s0.y.yi"
	...
	.falign
.LBB120_79:                             // %call_destructor.exit6
	{
		call ##halide_qurt_hvx_unlock_as_destructor
		r1:0 = combine(#1,#0)
	}
	.falign
// %bb.80:                              // %call_destructor.exit6
	{
		r0 = #0
		r17:16 = memd(r30+#-8)
		r19:18 = memd(r30+#-16)
...
.Lfunc_end120:
	.size	gaussian3x3_hvx64, .Lfunc_end120-gaussian3x3_hvx64
                                        // -- End function
	.section	.text.gaussian3x3_hvx64_argv,"ax",@progbits
	.globl	gaussian3x3_hvx64_argv  // -- Begin function gaussian3x3_hvx64_argv
	.balign 32
	.type	gaussian3x3_hvx64_argv,@function
gaussian3x3_hvx64_argv:                 // @gaussian3x3_hvx64_argv
// %bb.0:                               // %entry
	{
		allocframe(r29,#0):raw
	}
	{
		call ##gaussian3x3_hvx64
		r1 = memw(r0+#4)
		r0 = memw(r0+#0)
	}
	{
...
.Lfunc_end121:
	.size	gaussian3x3_hvx64_argv, .Lfunc_end121-gaussian3x3_hvx64_argv
                                        // -- End function
	.section	.text.gaussian3x3_hvx64_metadata,"ax",@progbits
	.globl	gaussian3x3_hvx64_metadata // -- Begin function gaussian3x3_hvx64_metadata
	.balign 32
	.type	gaussian3x3_hvx64_metadata,@function
gaussian3x3_hvx64_metadata:             // @gaussian3x3_hvx64_metadata
// %bb.0:                               // %entry
	{
		r0 = add(pc,##.Lgaussian3x3_hvx64_metadata_storage@PCREL)
	}
	{
		jumpr r31
	}
.Lfunc_end122:
	.size	gaussian3x3_hvx64_metadata, .Lfunc_end122-gaussian3x3_hvx64_metadata
                                        // -- End function
...
.Lstr.111:
	...
	.p2align	5
.Lstr.112:
	.string	"gaussian3x3_hvx64"
	.size	.Lstr.112, 18

	.type	.Lgaussian3x3_hvx64_metadata_storage,@object // @gaussian3x3_hvx64_metadata_storage
	.section	.data.rel.ro,"aw",@progbits
	.p2align	4
.Lgaussian3x3_hvx64_metadata_storage:
	.word	0                       // 0x0
	.word	2                       // 0x2
	.word	.L__unnamed_1
	.word	.Lstr.111
	.word	.Lstr.112
	.size	.Lgaussian3x3_hvx64_metadata_storage, 20
