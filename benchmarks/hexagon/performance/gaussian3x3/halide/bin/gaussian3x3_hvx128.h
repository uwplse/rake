#ifndef HALIDE__bin___gaussian3x3_hvx128_h
#define HALIDE__bin___gaussian3x3_hvx128_h
#include <stdint.h>
...
int gaussian3x3_hvx128(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int gaussian3x3_hvx128_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *gaussian3x3_hvx128_metadata() HALIDE_FUNCTION_ATTRS;
...
inline int (*HALIDE_GET_STANDARD_ARGV_FUNCTION())(void**) {
    return gaussian3x3_hvx128_argv;
}
#endif
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return gaussian3x3_hvx128_metadata;
}
#endif
