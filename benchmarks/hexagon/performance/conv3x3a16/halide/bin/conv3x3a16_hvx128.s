...
.Lfunc_end119:
	.size	_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv, .Lfunc_end119-_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv
                                        // -- End function
	.section	.text.conv3x3a16_hvx128,"ax",@progbits
	.globl	conv3x3a16_hvx128       // -- Begin function conv3x3a16_hvx128
	.balign 32
	.type	conv3x3a16_hvx128,@function
conv3x3a16_hvx128:                      // @conv3x3a16_hvx128
// %bb.0:                               // %entry
	{
		r17:16 = combine(r1,r2)
		memd(r29+#-16) = r17:16
	...
	{
		r1 = add(pc,##conv3x3a16_hvx128.par_for.output.s0.y.yo@PCREL)
		r3 = add(r2,r3)
		memw(r29+#56) = r0
	}
	{
...
.Lfunc_end120:
	.size	conv3x3a16_hvx128, .Lfunc_end120-conv3x3a16_hvx128
                                        // -- End function
	.section	.text.conv3x3a16_hvx128.par_for.output.s0.y.yo,"ax",@progbits
	.balign 32                      // -- Begin function conv3x3a16_hvx128.par_for.output.s0.y.yo
	.type	conv3x3a16_hvx128.par_for.output.s0.y.yo,@function
conv3x3a16_hvx128.par_for.output.s0.y.yo: // @conv3x3a16_hvx128.par_for.output.s0.y.yo
// %bb.0:                               // %entry
	{
		r17 = r1
		r1 = #128
...
.LBB121_3:                              // %"for output.s0.y.y.y"
	...
	{
		if (p0) r16 = add(r13,#0)
		if (p0) r6 = memw(r29+#52)
		if (p0) r8 = memw(r29+#40)
	}                               // 4-byte Folded Reload
	{
		if (!p0) jump:nt .LBB121_7
		if (p0) r4 = memw(r29+#48)
		if (p0) memw(r29+#72) = r22
	}                               // 4-byte Folded Reload
// %bb.4:                               // %"for output.s0.x.x.preheader"
	...
	{
		r6 = insert(r8,#24,#8)
		v5:4.h = vmpa(v5:4.ub,r2.b)
		r9:8 = memd(r29+#24)
		memw(r29+#116) = r19
	}                               // 8-byte Folded Reload
	{
		v1:0.h = vmpa(v7:6.ub,r2.b)
		r8 = add(r9,#-1)
		v12 = vmemu(r26++#1)
	}
	{
		v7:6.h = vmpa(v19:18.ub,r2.b)
		p1 = cmp.gtu(r9,#1)
		v13 = vmemu(r11++#1)
	}
	{
	...
	{
		v5:4.h += vmpa(v13:12.ub,r24.b)
		v27 = v12
		v28 = vmemu(r4++#1)
	}
	{
		v7:6.h += vmpa(v21:20.ub,r24.b)
		v15 = v28
		v9 = vmemu(r17++#1)
	}
	{
		v1:0.h += vmpa(v29:28.ub,r24.b)
		v25 = v20
		v8 = vmemu(r28++#1)
	}
	{
...
.LBB121_5:                              // %"for output.s0.x.x"
	...
	{
		v7:6.h += vmpa(v27:26.ub,r1.b)
		v26 = vmemu(r23++#1)
	}
	{
		v3:2.h += vmpa(v15:14.ub,r1.b)
		v11 = v26
		v27 = vmemu(r9++#1)
	}
	{
		v1:0.h += vmpa(v25:24.ub,r1.b)
		v20 = vmemu(r12++#1)
	}
	{
		v3:2.h += vmpy(v21.ub,r7.b)
		v9 = v20
		v22 = vmemu(r13++#1)
	}
	{
		v3:2.h += vmpa(v27:26.ub,r6.b)
		v25 = v22
		v23 = vmemu(r0++#1)
	}
	{
		v1:0.h += vmpy(v26.ub,r7.b)
		v18 = v23
		v12 = vmemu(r28++#1)
	}
	{
		v1:0.h += vmpa(v21:20.ub,r6.b)
		v2.ub = vasr(v3.h,v2.h,r5):sat
		v17 = vmemu(r11++#1)
	}
	{
		v7:6.h += vmpy(v20.ub,r7.b)
		v19 = vmemu(r20++#1)
	}
	{
		v5:4.h += vmpy(v10.ub,r7.b)
		v0.ub = vasr(v1.h,v0.h,r5):sat
		v3 = vmemu(r22++#1)
	}
	{
		v7:6.h += vmpa(v11:10.ub,r6.b)
		v10 = v3
		v11 = vmemu(r16++#1)
	}
	{
		v5:4.h += vmpa(v9:8.ub,r6.b)
		v2 = v19
		vmemu(r19++#1) = v2
	}
	{
		v7:6.h = vmpa(v19:18.ub,r2.b)
		v1.ub = vasr(v7.h,v6.h,r5):sat
		vmemu(r21++#1) = v0
	}
	{
		v5:4.h = vmpa(v23:22.ub,r2.b)
		v8.ub = vasr(v5.h,v4.h,r5):sat
	}
	{
		v1:0.h = vmpa(v3:2.ub,r2.b)
		vmemu(r14++#1) = v1
	}
	{
		v3:2.h = vmpa(v11:10.ub,r2.b)
		vmemu(r15++#1) = v8
	}
	{
		v16 = vmemu(r26++#1)
	...
	{
		v1:0.h += vmpa(v23:22.ub,r24.b)
		v18 = vmemu(r18++#1)
	}
	{
		v7:6.h += vmpa(v25:24.ub,r24.b)
		v25 = v24
		v8 = vmemu(r25++#1)
	}
	{
...
.LBB121_6:                              //   in Loop: Header=BB121_3 Depth=1
	...
	{
		v3:2.h += vmpy(v15.ub,r7.b)
		r9 = memw(r29+#120)
		r26 = memw(r29+#88)
	}                               // 4-byte Folded Reload
	{
		v3:2.h += vmpa(v31:30.ub,r6.b)
		r23 = memw(r29+#92)
	}                               // 4-byte Folded Reload
	{
		v1:0.h += vmpy(v30.ub,r7.b)
	}
	{
		v5:4.h += vmpy(v10.ub,r7.b)
		v3.ub = vasr(v3.h,v2.h,r5):sat
	}
	{
		vmemu(r19++#1) = v3
	}
	...
	{
		v1:0.h += vmpa(v15:14.ub,r6.b)
	}
	{
		v7:6.h += vmpy(v14.ub,r7.b)
	}
	{
		v7:6.h += vmpa(v11:10.ub,r6.b)
		v31.ub = vasr(v1.h,v0.h,r5):sat
	}
	{
		v5:4.h += vmpa(v9:8.ub,r6.b)
	}
	{
		v6.ub = vasr(v7.h,v6.h,r5):sat
		vmemu(r21++#1) = v31
	}
	{
		v4.ub = vasr(v5.h,v4.h,r5):sat
		r21 = memw(r29+#136)
	}                               // 4-byte Folded Reload
	{
		vmemu(r14++#1) = v6
...
.Lfunc_end121:
	.size	conv3x3a16_hvx128.par_for.output.s0.y.yo, .Lfunc_end121-conv3x3a16_hvx128.par_for.output.s0.y.yo
                                        // -- End function
	.section	.text.conv3x3a16_hvx128_argv,"ax",@progbits
	.globl	conv3x3a16_hvx128_argv  // -- Begin function conv3x3a16_hvx128_argv
	.balign 32
	.type	conv3x3a16_hvx128_argv,@function
conv3x3a16_hvx128_argv:                 // @conv3x3a16_hvx128_argv
// %bb.0:                               // %entry
	{
		allocframe(r29,#0):raw
	}
...
.Lfunc_end122:
	.size	conv3x3a16_hvx128_argv, .Lfunc_end122-conv3x3a16_hvx128_argv
                                        // -- End function
	.section	.text.conv3x3a16_hvx128_metadata,"ax",@progbits
	.globl	conv3x3a16_hvx128_metadata // -- Begin function conv3x3a16_hvx128_metadata
	.balign 32
	.type	conv3x3a16_hvx128_metadata,@function
conv3x3a16_hvx128_metadata:             // @conv3x3a16_hvx128_metadata
// %bb.0:                               // %entry
	{
		r0 = add(pc,##.Lconv3x3a16_hvx128_metadata_storage@PCREL)
	}
	{
		jumpr r31
	}
.Lfunc_end123:
	.size	conv3x3a16_hvx128_metadata, .Lfunc_end123-conv3x3a16_hvx128_metadata
                                        // -- End function
...
.Lstr.112:
	...
	.p2align	5
.Lstr.113:
	.string	"conv3x3a16_hvx128"
	.size	.Lstr.113, 18

	.type	.Lconv3x3a16_hvx128_metadata_storage,@object // @conv3x3a16_hvx128_metadata_storage
	.section	.data.rel.ro,"aw",@progbits
	.p2align	4
.Lconv3x3a16_hvx128_metadata_storage:
	.word	0                       // 0x0
	.word	3                       // 0x3
	.word	.L__unnamed_1
	.word	.Lstr.112
	.word	.Lstr.113
	.size	.Lconv3x3a16_hvx128_metadata_storage, 20
