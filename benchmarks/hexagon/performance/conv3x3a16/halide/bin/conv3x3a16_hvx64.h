#ifndef HALIDE__bin___conv3x3a16_hvx64_h
#define HALIDE__bin___conv3x3a16_hvx64_h
#include <stdint.h>
...
int conv3x3a16_hvx64(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_mask_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int conv3x3a16_hvx64_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *conv3x3a16_hvx64_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return conv3x3a16_hvx64_metadata;
}
#endif
