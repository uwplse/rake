    ...
    )
{
    ...
    for ( i=width; i>VLEN; i-=VLEN)
    {
        ...
        dVsumv2 = Q6_Wuh_vzxt_Vub(sLine4);
        dVsumv2 = Q6_Wh_vmpaacc_WhWubRb(dVsumv2,Q6_W_vcombine_VV(sLine3,sLine1),const4);
        dVsumv2 = Q6_Wh_vmpaacc_WhWubRb(dVsumv2,Q6_W_vcombine_VV(sLine2,sLine0),0x06060101);
        
        // Halide's instructions
        //dVsumv2 = Q6_Wh_vadd_VubVub(sLine0,sLine4);
        //dVsumv2 = Q6_Wh_vmpyacc_WhVubRb(dVsumv2,sLine2,const6);
        //dVsumv2 = Q6_Wh_vmpaacc_WhWubRb(dVsumv2,Q6_W_vcombine_VV(sLine3,sLine1),const4);
        ...
        *optr++ = Q6_Vb_vshuffo_VbVb(
            Q6_Vw_vmpyiacc_VwVwRb(
                Q6_Vh_vadd_VhVh(
                    sVsum0,
                    Q6_Vw_vmpyiacc_VwVwRb(
                      Q6_Vw_vmpyiacc_VwVwRb(
