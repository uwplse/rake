#ifndef HALIDE__bin___gaussian5x5_hvx64_h
#define HALIDE__bin___gaussian5x5_hvx64_h
#include <stdint.h>
...
int gaussian5x5_hvx64(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int gaussian5x5_hvx64_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *gaussian5x5_hvx64_metadata() HALIDE_FUNCTION_ATTRS;
...
inline const struct halide_filter_metadata_t* (*HALIDE_GET_STANDARD_METADATA_FUNCTION())() {
    return gaussian5x5_hvx64_metadata;
}
#endif
