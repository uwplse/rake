...
.Lfunc_end119:
	...
	.globl	gaussian5x5_hvx64       // -- Begin function gaussian5x5_hvx64
	.balign 32
...
// %bb.1:                               // %entry
	...
	}
	{
		...
		if (p0.new) r7 = memw(r2+#4)
		if (p0.new) r12 = memw(r16+#12)
	}
// %bb.2:                               // %"for output.s0.y.preheader"
	...
	{
		r15 = add(r12,sub(#2,r14))
		r27 = addasl(r12,r4,#6)
		r7 = sub(#-1,r6)
		r8 = sub(#-1,r14)
	}
	{
		r26 = add(r12,sub(#2,r6))
		r22 = add(r12,sub(#1,r6))
		r7 = add(r12,r7)
		memw(r29+#128) = r7.new
	}                               // 4-byte Folded Spill
	{
		r17 = add(r12,sub(#-2,r6))
		r23 = add(r26,#-2)
		r7 = r15
		r24 = add(r27,#1)
	}
	{
		r21 = add(r12,sub(#1,r14))
		r19 = add(r12,sub(#-2,r14))
		r15 = add(r12,r8)
		r25 = add(r27,#-2)
	}
	{
...
// %bb.4:                               // %"for output.s0.x.x.preheader"
	...
	{
		v27:26.h += vmpa(v23:22.ub,r5.b)
		v3 = vmemu(r21++#1)
	}
	{
		v29:28.uh = vzxt(v3.ub)
		v18 = vmemu(r16++#1)
	}
	{
		v19 = vmemu(r10++#1)
	...
	{
		v29:28.h += vmpa(v31:30.ub,r5.b)
		v10 = vmemu(r27++#1)
	}
	{
		v25:24.uh = vzxt(v10.ub)
		v20 = vmemu(r19++#1)
	}
	{
		v21 = vmemu(r25++#1)
	...
	{
		v7:6.h += vmpa(v21:20.ub,r5.b)
		v9 = vmemu(r23++#1)
	}
	{
		v6.h += vmpyi(v26.h,r3.b)
		v7.h += vmpyi(v27.h,r3.b)
		v4 = vmemu(r17++#1)
	}
	{
		v29:28.h += vmpa(v9:8.ub,r6.b)
		v5 = vmemu(r28++#1)
	}
	{
		v2 = vmemu(r15++#1)
	...
	{
		v6.h += vmpyi(v28.h,r5.b)
		v7.h += vmpyi(v29.h,r5.b)
	}
	{
		v25:24.h += vmpa(v3:2.ub,r6.b)
		r6 = r7
		r7 = memw(r29+#20)
	}                               // 4-byte Folded Reload
	{
	...
	{
		v6.h += vmpyi(v24.h,r3.b)
		v7.h += vmpyi(v25.h,r3.b)
		v27:26.uh = vzxt(v4.ub)
	}
	{
		loop0(.LBB120_5,r7)
		v1:0.uh = vzxt(v0.ub)
...
.LBB120_5:                              // %"for output.s0.x.x"
	...
	{
		r3 = ##67503110
		v1:0.h = vadd(v1:0.h,v5:4.h)
	}
	{
		v1:0.h += vmpa(v3:2.ub,r3.b)
		r3 = ##100926980
		v5 = vmemu(r27++#1)
	}
	{
	...
	{
		v19:18.uh = vzxt(v5.ub)
		v1.b = vshuffo(v1.b,v0.b)
		v24 = vmemu(r17++#1)
	}
	{
		r9 = ##17039620
	...
	{
		v7:6.h += vmpa(v5:4.ub,r9.b)
		v14 = vmemu(r11++#1)
	}
	{
		v19:18.h += vmpa(v25:24.ub,r3.b)
		v15 = vmemu(r23++#1)
	}
	{
		v19:18.h += vmpa(v21:20.ub,r9.b)
		v22 = vmemu(r19++#1)
	}
	{
		v17:16.h += vmpa(v15:14.ub,r9.b)
		r9 = ##101058054
		v23 = vmemu(r25++#1)
	}
	{
	...
	{
		v1:0.h += vmpa(v23:22.ub,r3.b)
		r3 = ##67372036
	}
	{
		v1.h += vmpyi(v7.h,r3.b)
		v0.h += vmpyi(v6.h,r3.b)
		v9 = vmemu(r8++#1)
	}
	{
		v1.h += vmpyi(v17.h,r9.b)
		v0.h += vmpyi(v16.h,r9.b)
		v31:30.uh = vzxt(v8.ub)
	}
	{
		v1.h += vmpyi(v19.h,r3.b)
		v0.h += vmpyi(v18.h,r3.b)
		v2 = vmemu(r13++#1)
	}
	{
		v5:4.h = vadd(v1:0.h,v31:30.h)
		v3 = vmemu(r6++#1)
	}
	{
		nop
...
.LBB120_6:                              //   in Loop: Header=BB120_3 Depth=1
	{
		v13:12.h = vadd(v1:0.h,v5:4.h)
		r2 = ##67503110
		r17 = memw(r29+#76)
	}                               // 4-byte Folded Reload
	{
		v13:12.h += vmpa(v3:2.ub,r2.b)
		r21 = memw(r29+#68)
		r26 = memw(r29+#88)
	}                               // 4-byte Folded Reload
	{
		v11.b = vshuffo(v13.b,v12.b)
		r15 = memw(r29+#108)
		r19 = memw(r29+#64)
	}                               // 4-byte Folded Reload
	{
...
// %bb.8:                               // %true_bb
	...
	{
		v11:10.h += vmpa(v17:16.ub,r9.b)
		r3 = ##17039620
		memw(r29+#84) = r3
	}                               // 4-byte Folded Spill
	{
		v9:8.h += vmpa(v19:18.ub,r3.b)
		r15 = add(r6,#-65)
		v20 = vmemu(r15+#0)
	}
	{
	...
	{
		v9:8.h += vmpa(v23:22.ub,r9.b)
		r8 = add(r8,#-62)
		v13 = vmemu(r8+#-1)
	}
	{
		r13 = r11
		v31:30.uh = vzxt(v13.ub)
		v21 = vmemu(r13+#0)
	}
	{
		v19 = vmemu(r10+#0)
	...
	{
		r14 = r18
		v23:22.uh = vzxt(v19.ub)
		v6 = vmemu(r14+#-1)
	}
	{
		v11:10.h += vmpa(v21:20.ub,r3.b)
		r6 = add(r6,#-62)
		v7 = vmemu(r6+#-1)
	}
	{
	...
	{
		v8.h += vmpyi(v30.h,r2.b)
		v9.h += vmpyi(v31.h,r2.b)
		v26 = vmemu(r8+#0)
	}
	{
		v8.h += vmpyi(v22.h,r3.b)
		r2 = ##67503110
		v3:2.uh = vzxt(v27.ub)
	}
	{
		v9.h += vmpyi(v23.h,r3.b)
		v31:30.uh = vzxt(v26.ub)
		r7 = memw(r29+#112)
		r8 = memw(r29+#92)
	}                               // 4-byte Folded Reload
	{
		v9:8.h = vadd(v9:8.h,v3:2.h)
		v29 = vmemu(r4+#0)
	}
	{
		v1:0.h = vadd(v31:30.h,v9:8.h)
		r3 = memw(r29+#88)
		r15 = memw(r29+#108)
	}                               // 4-byte Folded Reload
	{
		v1:0.h += vmpa(v29:28.ub,r2.b)
		r4 = memw(r29+#0)
		r11 = memw(r29+#104)
	}                               // 4-byte Folded Reload
	{
		v31.b = vshuffo(v1.b,v0.b)
	}
	{
		r6 = memw(r29+#24)
		r2 = memw(r29+#96)
