...
.Lfunc_end119:
	...
	.globl	gaussian5x5_hvx128      // -- Begin function gaussian5x5_hvx128
	.balign 32
...
// %bb.2:                               // %"for output.s0.y.preheader"
	...
	{
		r13 = add(r7,sub(#2,r12))
		r5 = insert(r12,#31,#1)
		r2 = sub(#-1,r12)
		memw(r29+#128) = r13.new
	}                               // 4-byte Folded Spill
	{
		r11 = add(r7,sub(#1,r12))
		r26 = add(r7,r2)
		r2 = sub(#-1,r5)
		r27 = add(r7,r5)
	}
...
// %bb.4:                               // %"for output.s0.x.x.preheader"
	...
	{
		r19:18 = combine(r24,r21)
		r5 = ##101058054
		memw(r29+#64) = r18
	}                               // 4-byte Folded Spill
	{
		r25:24 = combine(r14,r13)
		r14 = r3
		memw(r29+#44) = r24
	}                               // 4-byte Folded Spill
	{
	...
	{
		v7:6.h += vmpa(v21:20.ub,r8.b)
		v9 = vmemu(r23++#1)
	}
	{
		v6.h += vmpyi(v26.h,r6.b)
		v7.h += vmpyi(v27.h,r6.b)
		v4 = vmemu(r17++#1)
	}
	{
		v29:28.h += vmpa(v9:8.ub,r7.b)
		v5 = vmemu(r0++#1)
	}
	{
		v2 = vmemu(r28++#1)
	...
	{
		v6.h += vmpyi(v24.h,r6.b)
		v7.h += vmpyi(v25.h,r6.b)
...
.LBB120_5:                              // %"for output.s0.x.x"
	...
	{
		v7:6.h += vmpa(v5:4.ub,r8.b)
		v14 = vmemu(r11++#1)
	}
	{
		v19:18.h += vmpa(v25:24.ub,r6.b)
		v15 = vmemu(r23++#1)
	}
	{
		v19:18.h += vmpa(v21:20.ub,r8.b)
		v22 = vmemu(r19++#1)
	}
	{
		v17:16.h += vmpa(v15:14.ub,r8.b)
		r8 = ##101058054
		v23 = vmemu(r25++#1)
	}
	{
	...
	{
		v1.h += vmpyi(v17.h,r8.b)
		v0.h += vmpyi(v16.h,r8.b)
		v2 = vmemu(r9++#1)
	}
	{
...
// %bb.8:                               // %true_bb
	...
	{
		v31:30.h += vmpa(v7:6.ub,r3.b)
		v25 = vmemu(r15+#0)
	}
	{
		v31:30.h += vmpa(v3:2.ub,r8.b)
		r15 = memw(r29+#84)
		r1 = memw(r29+#96)
	}                               // 4-byte Folded Reload
	{
	...
	{
		v8.h += vmpyi(v10.h,r6.b)
		v27 = vmemu(r0+#0)
	}
	{
		v23:22.h += vmpa(v25:24.ub,r3.b)
		r3 = ##67503110
		r12 = memw(r29+#92)
	}                               // 4-byte Folded Reload
	{
		v9.h += vmpyi(v11.h,r6.b)
		r6 = ##101058054
		r10 = memw(r29+#104)
	}                               // 4-byte Folded Reload
	{
		v23:22.h += vmpa(v27:26.ub,r8.b)
		r8 = ##100926980
		v28 = vmemu(r5+#0)
	}
	{
	...
	{
		v8.h += vmpyi(v30.h,r6.b)
		v9.h += vmpyi(v31.h,r6.b)
		r6 = ##67372036
	}
	{
		v3:2.uh = vzxt(v27.ub)
	...
	{
		v8.h += vmpyi(v22.h,r6.b)
		v9.h += vmpyi(v23.h,r6.b)
