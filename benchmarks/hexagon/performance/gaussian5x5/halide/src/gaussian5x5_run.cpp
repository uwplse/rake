...
int main(int argc, char **argv) {
  ...
  char *filename = (char *) malloc(100 * sizeof(char));
    ...
    printf("AppReported (HVX64B-mode): Image %dx%d - gaussian5x5(64B): %lld cycles (%0.4f cycles/pixel)\n", (int)width, (int)height, cycles_hvx64, (float)cycles_hvx64/width/height);
    /* -----------------------------------------------------*/
    /*  Write image output to file                          */
    /* -----------------------------------------------------*/
    strcpy(filename, "out/gaussian5x5_hvx64_");
    ...
    strcpy(filename, "out/gaussian5x5_hvx128_");
    strcat(filename, argv[4]);
