...
(define t59 (load rows (ramp (+ (* output.s0.x.x 128) 64) 1 64) (aligned 128 64)))
(define t60.s (load rows (ramp (* output.s0.x.x 128) 1 64) (aligned 128 0)))
(define t61.s (load rows (ramp (+ (* output.s0.x.x 128) 128) 1 64) (aligned 128 0)))
