...
(define t14 (+ (* output.s0.x.x 128) (* (+ (* output.s0.y.y.y 4) output.s0.y.y.base) input.stride.1)))
    ...
    (vec-div
     (vec-add
      (vec-mul
       (int16x128
        (uint16x128
         (load input (ramp (+ t14 -1) 1 128) (aligned 128 127))))
       (int16x128
        (x128 (get mask 3))))
      (vec-add
       (vec-mul
        (int16x128
         (uint16x128
          (load input (ramp (+ (+ (* input.stride.1 -1) t14) -1) 1 128) (aligned 1 0))))
        (int16x128
         (x128 (get mask 0))))
       (vec-add
        (vec-mul
         (int16x128
          (uint16x128
           (load input (ramp (+ (+ input.stride.1 t14) -1) 1 128) (aligned 128 127))))
         (int16x128
          (x128 (get mask 6))))
        (vec-add
         (vec-mul
          (int16x128
           (uint16x128
            (load input (ramp (+ (* input.stride.1 -1) t14) 1 128) (aligned 1 0))))
          (int16x128
           (x128 (get mask 1))))
         (vec-add
          (vec-mul
           (int16x128
            (uint16x128
             (load input (ramp t14 1 128) (aligned 128 0))))
           (int16x128
            (x128 (get mask 4))))
          (vec-add
           (vec-mul
            (int16x128
             (uint16x128
              (load input (ramp (+ input.stride.1 t14) 1 128) (aligned 128 0))))
            (int16x128
             (x128 (get mask 7))))
           (vec-add
            (vec-mul
            ...
            (vec-add
             (vec-mul
              (int16x128
               (uint16x128
                (load input (ramp (+ (+ input.stride.1 t14) 1) 1 128) (aligned 128 1))))
              (int16x128
               (x128 (get mask 8))))
             (vec-mul
              (int16x128
               (uint16x128
                (load input (ramp (+ t14 1) 1 128) (aligned 128 1))))
              (int16x128
               (x128 (get mask 5))))))))))))
