 ...
 (vec-add
  (vec-add
   (vec-add
    (vec-mul
     (int16x128
      (load input (ramp (+ (* (+ (* t19 -4) input.stride.1) -1) -2) 1 128)))
     (x128 (int16_t (bv 4 16))))
    (vec-add
     (vec-mul
      (int16x128
       (load input (ramp (+ (* t19 4) -2) 1 128)))
      (int16x128
       (x128 (int8_t (bv 6 8)))))
     (vec-mul
      (int16x128
       (load input (ramp (+ (+ (* t19 4) input.stride.1) -2) 1 128)))
      (x128 (int16_t (bv 4 16))))))
   (int16x128
    (load input (ramp (+ (* (+ (* t19 -2) input.stride.1) -2) -2) 1 128))))
  (int16x128
   (load input (ramp (+ (* (+ (* t19 2) input.stride.1) 2) -2) 1 128)))))
