...
(define halide-expr
 (uint8x128
  (vec-div
   (vec-add
    (vec-mul
     (load rows (ramp (+ (+ (* output.s0.x.x 128) t31) 129) 1 128))
     (x128 (int16_t (bv 4 16))))
    (vec-add
     (load rows (ramp (+ (+ (* output.s0.x.x 128) t31) 128) 1 128))
     (vec-add
      (vec-mul
       (load rows (ramp (+ (+ (* output.s0.x.x 128) t31) 130) 1 128))
       (x128 (int16_t (bv 6 16))))
      (vec-add
       (load rows (ramp (+ (+ (* output.s0.x.x 128) t31) 132) 1 128))
       (vec-mul
        (load rows (ramp (+ (+ (* output.s0.x.x 128) t31) 131) 1 128))
        (x128 (int16_t (bv 4 16))))))))
