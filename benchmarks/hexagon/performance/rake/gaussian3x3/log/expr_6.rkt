...
(define t54 (load rows (ramp (+ (* (+ (* (quotient (+ t20 255) 128) 2) output.s0.x.x) 128) 64) 1 64) (aligned 128 64)))
(define t55.s (load rows (ramp (* (+ (* (quotient (+ t20 255) 128) 2) output.s0.x.x) 128) 1 64) (aligned 128 0)))
(define t56.s (load rows (ramp (+ (* (+ (* (quotient (+ t20 255) 128) 2) output.s0.x.x) 128) 128) 1 64) (aligned 128 0)))
