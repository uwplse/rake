#ifndef HALIDE_____bin___arm___64___android___basic4_h
#define HALIDE_____bin___arm___64___android___basic4_h
#include <stdint.h>
...
int basic4(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int basic4_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *basic4_metadata() HALIDE_FUNCTION_ATTRS;
