#ifndef HALIDE_____bin___host___MatrixMultiply_h
#define HALIDE_____bin___host___MatrixMultiply_h
#include <stdint.h>
...
int MatrixMultiply(struct halide_buffer_t *_mat_a_buffer, struct halide_buffer_t *_mat_b_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int MatrixMultiply_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *MatrixMultiply_metadata() HALIDE_FUNCTION_ATTRS;
