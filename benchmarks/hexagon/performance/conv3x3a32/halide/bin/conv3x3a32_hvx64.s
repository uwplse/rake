...
.Lfunc_end119:
	.size	_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv, .Lfunc_end119-_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv
                                        // -- End function
	.section	.text.conv3x3a32_hvx64,"ax",@progbits
	.globl	conv3x3a32_hvx64        // -- Begin function conv3x3a32_hvx64
	.balign 32
	.type	conv3x3a32_hvx64,@function
conv3x3a32_hvx64:                       // @conv3x3a32_hvx64
// %bb.0:                               // %entry
	{
...
.LBB120_3:                              // %"for output.s0.y"
                                        ...
                                        //     Child Loop BB120_5 Depth 2
	{
		...
		if (p0) r4 = memw(r29+#76)
		if (p0) memw(r29+#124) = r19
	}                               // 4-byte Folded Reload
...
.LBB120_7:                              // %"end for output.s0.x.x"
                                        //   in Loop: Header=BB120_3 Depth=1
	{
		if (p1) r15 = add(r19,#-1)
		if (p1) r5 = add(r19,#1)
		if (p1) r1 = memw(r29+#92)
		if (p1) r2 = memw(r29+#64)
	}                               // 4-byte Folded Reload
	{
		if (p1) r4 = memw(r29+#60)
	}                               // 4-byte Folded Reload
	{
		if (p1) r14 = add(r2,r4)
	}
...
.Lfunc_end120:
	.size	conv3x3a32_hvx64, .Lfunc_end120-conv3x3a32_hvx64
                                        // -- End function
	.section	.text.conv3x3a32_hvx64_argv,"ax",@progbits
	.globl	conv3x3a32_hvx64_argv   // -- Begin function conv3x3a32_hvx64_argv
	.balign 32
	.type	conv3x3a32_hvx64_argv,@function
conv3x3a32_hvx64_argv:                  // @conv3x3a32_hvx64_argv
// %bb.0:                               // %entry
	{
		allocframe(r29,#0):raw
	}
...
.Lfunc_end121:
	.size	conv3x3a32_hvx64_argv, .Lfunc_end121-conv3x3a32_hvx64_argv
                                        // -- End function
	.section	.text.conv3x3a32_hvx64_metadata,"ax",@progbits
	.globl	conv3x3a32_hvx64_metadata // -- Begin function conv3x3a32_hvx64_metadata
	.balign 32
	.type	conv3x3a32_hvx64_metadata,@function
conv3x3a32_hvx64_metadata:              // @conv3x3a32_hvx64_metadata
// %bb.0:                               // %entry
	{
		r0 = add(pc,##.Lconv3x3a32_hvx64_metadata_storage@PCREL)
	}
	{
		jumpr r31
	}
.Lfunc_end122:
	.size	conv3x3a32_hvx64_metadata, .Lfunc_end122-conv3x3a32_hvx64_metadata
                                        // -- End function
...
.Lstr.112:
	...
	.p2align	5
.Lstr.113:
	.string	"conv3x3a32_hvx64"
	.size	.Lstr.113, 17

	.type	.Lconv3x3a32_hvx64_metadata_storage,@object // @conv3x3a32_hvx64_metadata_storage
	.section	.data.rel.ro,"aw",@progbits
	.p2align	4
.Lconv3x3a32_hvx64_metadata_storage:
	.word	0                       // 0x0
	.word	3                       // 0x3
	.word	.L__unnamed_1
	.word	.Lstr.112
	.word	.Lstr.113
	.size	.Lconv3x3a32_hvx64_metadata_storage, 20
