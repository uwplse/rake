#ifndef HALIDE__bin___sobel_hvx64_h
#define HALIDE__bin___sobel_hvx64_h
#include <stdint.h>
...
int sobel_hvx64(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int sobel_hvx64_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *sobel_hvx64_metadata() HALIDE_FUNCTION_ATTRS;
