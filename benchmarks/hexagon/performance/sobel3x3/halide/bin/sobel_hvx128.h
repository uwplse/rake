#ifndef HALIDE__bin___sobel_hvx128_h
#define HALIDE__bin___sobel_hvx128_h
#include <stdint.h>
...
int sobel_hvx128(struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_output_buffer) HALIDE_FUNCTION_ATTRS;
int sobel_hvx128_argv(void **args) HALIDE_FUNCTION_ATTRS;
const struct halide_filter_metadata_t *sobel_hvx128_metadata() HALIDE_FUNCTION_ATTRS;
