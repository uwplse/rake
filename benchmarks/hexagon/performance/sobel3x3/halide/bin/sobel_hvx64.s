...
.Lfunc_end119:
	.size	_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv, .Lfunc_end119-_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv
                                        // -- End function
	.section	.text.sobel_hvx64,"ax",@progbits
	.globl	sobel_hvx64             // -- Begin function sobel_hvx64
	.balign 32
	.type	sobel_hvx64,@function
sobel_hvx64:                            // @sobel_hvx64
// %bb.0:                               // %entry
	{
		r3 = memw(r1+#12)
		allocframe(#112)
	...
	{
		r1 = add(pc,##sobel_hvx64.par_for.output.s0.y.yo@PCREL)
		p1 = and(p0,!p1)
		r0 = #0
	}
	{
...
.Lfunc_end120:
	.size	sobel_hvx64, .Lfunc_end120-sobel_hvx64
                                        // -- End function
	.section	.text.sobel_hvx64.par_for.output.s0.y.yo,"ax",@progbits
	.balign 32                      // -- Begin function sobel_hvx64.par_for.output.s0.y.yo
	.type	sobel_hvx64.par_for.output.s0.y.yo,@function
sobel_hvx64.par_for.output.s0.y.yo:     // @sobel_hvx64.par_for.output.s0.y.yo
// %bb.0:                               // %entry
	{
		r3 = memw(r2+#4)
...
.Lfunc_end121:
	.size	sobel_hvx64.par_for.output.s0.y.yo, .Lfunc_end121-sobel_hvx64.par_for.output.s0.y.yo
                                        // -- End function
	.section	.text.sobel_hvx64_argv,"ax",@progbits
	.globl	sobel_hvx64_argv        // -- Begin function sobel_hvx64_argv
	.balign 32
	.type	sobel_hvx64_argv,@function
sobel_hvx64_argv:                       // @sobel_hvx64_argv
// %bb.0:                               // %entry
	{
		allocframe(r29,#0):raw
	}
...
.Lfunc_end122:
	.size	sobel_hvx64_argv, .Lfunc_end122-sobel_hvx64_argv
                                        // -- End function
	.section	.text.sobel_hvx64_metadata,"ax",@progbits
	.globl	sobel_hvx64_metadata    // -- Begin function sobel_hvx64_metadata
	.balign 32
	.type	sobel_hvx64_metadata,@function
sobel_hvx64_metadata:                   // @sobel_hvx64_metadata
// %bb.0:                               // %entry
	{
		r0 = add(pc,##.Lsobel_hvx64_metadata_storage@PCREL)
	}
	{
		jumpr r31
	}
.Lfunc_end123:
	.size	sobel_hvx64_metadata, .Lfunc_end123-sobel_hvx64_metadata
                                        // -- End function
...
.Lstr.112:
	...
	.type	.Lsobel_hvx64_metadata_storage,@object // @sobel_hvx64_metadata_storage
	.section	.data.rel.ro,"aw",@progbits
	.p2align	4
.Lsobel_hvx64_metadata_storage:
	.word	0                       // 0x0
	.word	2                       // 0x2
	.word	.L__unnamed_1
	.word	.Lstr.111
	.word	.Lstr.112
	.size	.Lsobel_hvx64_metadata_storage, 20
