...
.Lfunc_end119:
	.size	_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv, .Lfunc_end119-_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv
                                        // -- End function
	.section	.text.sobel_hvx128,"ax",@progbits
	.globl	sobel_hvx128            // -- Begin function sobel_hvx128
	.balign 32
	.type	sobel_hvx128,@function
...
.Lfunc_end120:
	...
	.balign 32
	.type	sobel_hvx128_argv,@function
sobel_hvx128_argv:                      // @sobel_hvx128_argv
// %bb.0:                               // %entry
	{
		allocframe(r29,#0):raw
	}
...
.Lfunc_end121:
	...
	.balign 32
	.type	sobel_hvx128_metadata,@function
sobel_hvx128_metadata:                  // @sobel_hvx128_metadata
// %bb.0:                               // %entry
	{
		r0 = add(pc,##.Lsobel_hvx128_metadata_storage@PCREL)
	}
	{
		jumpr r31
	}
...
.Lstr.112:
	...
	.type	.Lsobel_hvx128_metadata_storage,@object // @sobel_hvx128_metadata_storage
	.section	.data.rel.ro,"aw",@progbits
	.p2align	4
.Lsobel_hvx128_metadata_storage:
	.word	0                       // 0x0
	.word	2                       // 0x2
	.word	.L__unnamed_1
	.word	.Lstr.111
	.word	.Lstr.112
	.size	.Lsobel_hvx128_metadata_storage, 20
