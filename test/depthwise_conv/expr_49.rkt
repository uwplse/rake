...
(define halide-expr
 (vec-sub
  (int16x64
   (slice_vectors
    (load filter (ramp (sca-add (sca-mul filter.stride.1 filter_zeroed.s0.x) (sca-add (sca-mul filter.stride.2 filter_zeroed.s0.y) output.s0.c.c.base)) 1 128) (aligned 1 0)) 0 1 64))
  (int16x64
   (x64 filter_zero))))
