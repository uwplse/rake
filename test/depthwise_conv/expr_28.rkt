...
(define t2294 (var-lookup 't2294 t2626))
...
(define halide-expr
 (vec-add
  (vec-mul
   (int32x128
    (load filter_zeroed (ramp (sca-add (sca-mul t2175 128) 256) 1 128) (aligned 128 0)))
   (int32x128
    (int16x128
     (load resampled_input (ramp (sca-mul (sca-add (sca-mul (sca-add (sca-add output.min.1 output.s0.x.x.base.s) 1) stride_x) (sca-add (sca-sub (sca-mul dilation_x 2) t2230) t2294)) 128) 1 128) (aligned 128 0)))))
  (load convolved (ramp 384 1 128) (aligned 0 384))))
