...
(define halide-expr
 (vec-add
  (vec-mul
   ...
   (int32x128
    (int16x128
     (load resampled_input (ramp (sca-mul (sca-add (sca-mul (sca-add (sca-add output.min.1 output.s0.x.x.base.s) 1) stride_x) (sca-sub t2293 t2230)) 128) 1 128) (aligned 128 0)))))
