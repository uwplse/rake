...
(define t332.s (var-lookup 't332.s (sca-sub  (sca-sub  (sca-sub  input.min.0  t471)  t470)  t469)))
(define t342 (var-lookup 't342 (sca-min  (sca-sub  input.min.1  t476)  filter_width)))
(define t355 (var-lookup 't355 (sca-add  (sca-max  t342  0)  t479)))
(define t354 (var-lookup 't354 (sca-add  t482  (sca-sub  t332.s  input.min.0))))
...
(define t362 (var-lookup 't362 (sca-add  t483  (sca-add  output.s0.c.v8.base.s  t354))))
