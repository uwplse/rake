...
(define t298.s (var-lookup 't298.s (sca-sub  (sca-sub  (sca-sub  input.min.0  t450)  t449)  t448)))
(define t308 (var-lookup 't308 (sca-min  (sca-sub  input.min.1  t455)  filter_width)))
(define t321 (var-lookup 't321 (sca-add  (sca-max  t308  0)  t458)))
(define t320 (var-lookup 't320 (sca-add  t461  (sca-sub  t298.s  input.min.0))))
...
(define t328 (var-lookup 't328 (sca-add  t463  (sca-add  output.s0.c.v7.base.s  t320))))
