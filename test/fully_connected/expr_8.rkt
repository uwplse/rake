 ...
 (vec-add
  (vector_reduce 'add 4
   (int32x128
    (vec-mul
     (uint16x128
      (load filter (ramp (sca-add (sca-mul multiplied_intm.s1.r9$x.r9$x.r58 128) (sca-mul (sca-add (sca-add (sca-sub output.min.0 filter.min.1) output.s0.c.c.base.s) 3) filter.stride.1)) 1 128) (aligned 1 0)))
     (uint16x128
      (load input (ramp (sca-add (sca-mul multiplied_intm.s1.r9$x.r9$x.r58 128) (sca-sub (sca-mul (sca-add (sca-sub (sca-add output.min.1 output.s0.b.b.base.s) input.min.1) 1) input.stride.1) input.min.0)) 1 128) (aligned 1 0))))))
  (load multiplied_intm (ramp 416 1 32) (aligned 0 416))))
