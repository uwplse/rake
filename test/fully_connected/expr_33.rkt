...
(define halide-expr
 (vec-add
  (vector_reduce 'add 4
   (uint32x128
    (load filter (ramp (sca-add (sca-mul multiplied_intm.s1.r9$x.r9$x.r58 128) (sca-mul (sca-add (sca-add (sca-sub output.min.0 filter.min.1) output.s0.c.c.base.s) 4) filter.stride.1)) 1 128) (aligned 1 0))))
  (load sum_filter_intm (ramp 128 1 32) (aligned 0 128))))
