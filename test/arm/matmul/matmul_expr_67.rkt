...
(require rake)
(init-logging "matmul_expr_67.runtimes")
...
(define-symbolic t6638 integer?)
(define-symbolic-var t5829 int32_t)
(define-symbolic-var t5830 int32_t)
...
(define-symbolic-var t6653 int32_t)
...
(define t6121 (var-lookup 't6121 (sca-sub  t6638  t6114)))
   ...
   (vec-add
    (vec-add
     ...
     (vec-add
      ...
      (x16 (sca-add (sca-mul (sca-mul t5829 t5830) mat_a.extent.0) (sca-mul t5830 t6653)))))
    (int32x16
     (load multiplied_no_offsets (ramp (sca-add (sca-add (sca-mul output.s0.x.x 16) t6121) 4) 1 16) (aligned 4 0)))))
  (int64x16
...
(llvm-codegen arm-expr "matmul_sexp_67.out")