...
(define column_sums_b.s0.x.v12.base.s (var-lookup 'column_sums_b.s0.x.v12.base.s (sca-min  (sca-add  t5837  -1)  column_sums_b.s0.x.x)))
(define t5838 (var-lookup 't5838 (sca-mul  column_sums_b.s0.x.v12.base.s  16)))
...
(llvm-codegen arm-expr "matmul_sexp_0.out")