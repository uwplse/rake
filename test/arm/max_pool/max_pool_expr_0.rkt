...
(define t251 (var-lookup 't251 (sca-sub  (sca-sub  (sca-sub  (sca-sub  input.min.0  t421)  t420)  t419)  input.min.0)))
...
(define halide-expr
 (vec-max
  ...
  (load input (ramp (sca-add (sca-mul (sca-add maximum.s1.r12$x.rebased t276) input.stride.1) t279) 1 64) (aligned 1 0))))

(define spec (synthesis-spec 'halide-ir halide-expr axioms))
(define arm-expr (synthesize-arm spec 'greedy 'enumerative 'enumerative))

(llvm-codegen arm-expr "max_pool_sexp_0.out")