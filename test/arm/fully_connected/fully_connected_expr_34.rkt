...
(require rake)
(init-logging "fully_connected_expr_34.runtimes")
 ...
 (vec-add
  (vector_reduce 'add 4
   (int32x16
    (vec-mul
     (uint16x16
      (load filter (ramp (sca-add (sca-mul multiplied_intm.s1.r9$x.r9$x.r58 16) t704) 1 16) (aligned 1 0)))
     (uint16x16
...
(llvm-codegen arm-expr "fully_connected_sexp_34.out")