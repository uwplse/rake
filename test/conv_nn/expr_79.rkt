...
(define-symbolic t1595 integer?)
(define-symbolic t1596 integer?)
...
(define t1021.s (var-lookup 't1021.s (sca-add  t1596  t1595)))
  ...
  (vector_reduce 'add 4
   (int32x128
    (vec-mul
     (uint16x128
      (vec-broadcast 32
       (load input (ramp (sca-add (sca-mul convolved.s1.r19$z.r124 4) (sca-add (sca-mul input.stride.1 t1021.s) t1013)) 1 4) (aligned 4 0))))
     (uint16x128
...
(llvm-codegen hvx-expr "sexp_79.out")