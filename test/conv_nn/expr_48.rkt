...
(define-symbolic t1375 integer?)
(define-symbolic convolved.s1.r19$z.r124 integer?)
(define-symbolic t1371 integer?)
(define-symbolic t1376 integer?)
(define-symbolic t1372 integer?)
...
(define t918 (var-lookup 't918 (sca-add  t1372  t1371)))
(define t930.s (var-lookup 't930.s (sca-add  t1376  t1375)))
  ...
  (vector_reduce 'add 4
   (int32x128
    (vec-mul
     (uint16x128
      (vec-broadcast 32
       (load input (ramp (sca-add (sca-mul convolved.s1.r19$z.r124 4) (sca-add (sca-mul input.stride.1 t930.s) t915)) 1 4) (aligned 4 0))))
     (uint16x128
      (load filter (ramp (sca-add (sca-mul convolved.s1.r19$z.r124 128) (sca-add (sca-mul convolved.s1.r19$x filter.stride.4) t918)) 1 128) (aligned 128 0))))))
  (load convolved (ramp 704 1 32) (aligned 0 704))))

(define spec (synthesis-spec 'halide-ir halide-expr axioms))
(define hvx-expr (synthesize-hvx spec 'greedy 'enumerative 'enumerative))

(llvm-codegen hvx-expr "sexp_48.out")