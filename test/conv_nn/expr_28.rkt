...
(define-symbolic t1385 integer?)
(define-symbolic t1386 integer?)
...
(define t921.s (var-lookup 't921.s (sca-add  t1386  t1385)))
  ...
  (vector_reduce 'add 4
   (int32x128
    (vec-mul
     (uint16x128
      (vec-broadcast 32
       (load input (ramp (sca-add (sca-mul convolved.s1.r19$z.r124 4) (sca-add (sca-mul input.stride.1 t921.s) t915)) 1 4) (aligned 4 0))))
     (uint16x128
