...
(define-symbolic t1380 integer?)
(define-symbolic t1379 integer?)
...
(define t928.s (var-lookup 't928.s (sca-add  t1380  t1379)))
  ...
  (vector_reduce 'add 4
   (int32x128
    (vec-mul
     (uint16x128
      (vec-broadcast 32
       (load input (ramp (sca-add (sca-mul convolved.s1.r19$z.r124 4) (sca-add (sca-mul input.stride.1 t928.s) t915)) 1 4) (aligned 4 0))))
     (uint16x128
