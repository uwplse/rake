...
(require rake)
(init-logging "expr_111.runtimes")
...
(define-symbolic t1775 integer?)
(define-symbolic t1776 integer?)
...
(define t1114.s (var-lookup 't1114.s (sca-add  t1776  t1775)))
  ...
  (vector_reduce 'add 4
   (int32x128
    (vec-mul
     (uint16x128
      (vec-broadcast 32
       (load input (ramp (sca-add (sca-mul convolved.s1.r19$z.r124 4) (sca-add (sca-mul input.stride.1 t1114.s) t1108)) 1 4) (aligned 4 0))))
     (uint16x128
...
(llvm-codegen hvx-expr "sexp_111.out")