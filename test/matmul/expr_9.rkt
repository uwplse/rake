...
(define-symbolic-var t203 int32_t)
(define-symbolic-var t204 int32_t)
 ...
 (let ([t208  (vec-mul
  (int64x128
   (vec-add
    ...
    (x128 (sca-add (sca-mul (sca-mul t204 t205) mat_a.extent.0) (sca-mul t206 t207)))))
  (int64x128
