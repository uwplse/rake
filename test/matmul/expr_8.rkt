...
(define-symbolic-var t194 int32_t)
(define-symbolic-var t195 int32_t)
...
(define-symbolic-var t196 int32_t)
(define-symbolic-var output_multiplier int32_t)
(define-symbolic-var output_shift int32_t)
(define-symbolic-var t193 int32_t)
(define-symbolic-var t197 int32_t)
 ...
 (let ([t198  (vec-mul
  (int64x128
   (vec-add
    ...
    (x128 (sca-add (sca-mul (sca-mul t194 t195) mat_a.extent.0) (sca-mul t196 t197)))))
  (int64x128
