...
(define-symbolic-var t185 int32_t)
(define-symbolic-var t186 int32_t)
(define-symbolic-var t183 int32_t)
 ...
 (let ([t188  (vec-mul
  (int64x128
   (vec-add
    ...
    (x128 (sca-add (sca-mul (sca-mul t184 t185) mat_a.extent.0) (sca-mul t186 t187)))))
  (int64x128
