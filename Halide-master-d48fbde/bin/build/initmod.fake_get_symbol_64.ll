...
@_ZN6Halide7Runtime8Internal17custom_get_symbolE = weak local_unnamed_addr global i8* (i8*)* @halide_default_get_symbol, align 8
@_ZN6Halide7Runtime8Internal19custom_load_libraryE = weak local_unnamed_addr global i8* (i8*)* @halide_default_load_library, align 8
@_ZN6Halide7Runtime8Internal25custom_get_library_symbolE = weak local_unnamed_addr global i8* (i8*, i8*)* @halide_default_get_library_symbol, align 8

; Function Attrs: nounwind mustprogress
define weak i8* @halide_default_get_symbol(i8* %0) #0 {
  tail call void @halide_error(i8* null, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str, i64 0, i64 0)) #3
  ret i8* null
}
...
define weak i8* @halide_default_load_library(i8* %0) #0 {
  tail call void @halide_error(i8* null, i8* getelementptr inbounds ([62 x i8], [62 x i8]* @.str.1, i64 0, i64 0)) #3
  ret i8* null
}

; Function Attrs: nounwind mustprogress
define weak i8* @halide_default_get_library_symbol(i8* %0, i8* %1) #0 {
  tail call void @halide_error(i8* null, i8* getelementptr inbounds ([68 x i8], [68 x i8]* @.str.2, i64 0, i64 0)) #3
  ret i8* null
}
