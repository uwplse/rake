...
define weak dso_local i32 @halide_trace_helper(i8* %0, i8* %1, i8* %2, i32* %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, i8* %11) local_unnamed_addr #0 !dbg !41 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 56, i8* nonnull %14) #4, !dbg !114
  ...
  call void @llvm.dbg.value(metadata %struct.halide_trace_event_t* %13, metadata !122, metadata !DIExpression(DW_OP_plus_uconst, 32, DW_OP_stack_value)), !dbg !126
  %15 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 4, i32 0, !dbg !128
  %16 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 4, i32 1, !dbg !129
  %17 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 4, i32 2, !dbg !130
  %18 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 0, !dbg !131
  store i8* %1, i8** %18, align 8, !dbg !132, !tbaa !133
  %19 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 1, !dbg !143
  store i8* %2, i8** %19, align 8, !dbg !144, !tbaa !145
  %20 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 2, !dbg !146
  store i32* %3, i32** %20, align 8, !dbg !147, !tbaa !148
  %21 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 3, !dbg !149
  store i8* %11, i8** %21, align 8, !dbg !150, !tbaa !151
  %22 = trunc i32 %4 to i8, !dbg !152
  store i8 %22, i8* %15, align 8, !dbg !153, !tbaa !154
  ...
  %25 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 5, !dbg !161
  store i32 %7, i32* %25, align 4, !dbg !162, !tbaa !163
  %26 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 6, !dbg !164
  store i32 %8, i32* %26, align 8, !dbg !165, !tbaa !166
  %27 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 7, !dbg !167
  store i32 %9, i32* %27, align 4, !dbg !168, !tbaa !169
  %28 = getelementptr inbounds %struct.halide_trace_event_t, %struct.halide_trace_event_t* %13, i64 0, i32 8, !dbg !170
  store i32 %10, i32* %28, align 8, !dbg !171, !tbaa !172
  %29 = call i32 @halide_msan_annotate_memory_is_initialized(i8* %0, i8* nonnull %14, i64 56) #5, !dbg !173
  ...
  %36 = sext i32 %10 to i64, !dbg !180
  %37 = shl nsw i64 %36, 2, !dbg !181
  ...
  call void @llvm.lifetime.end.p0i8(i64 56, i8* nonnull %14) #4, !dbg !184
  ret i32 %39, !dbg !185
}
...
!65 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "halide_trace_event_t", file: !4, line: 505, size: 448, flags: DIFlagTypePassByValue | DIFlagNonTrivial, elements: !66, identifier: "_ZTS20halide_trace_event_t")
!66 = !{!67, !68, !69, !72, !73, !105, !106, !107, !108, !109}
!67 = !DIDerivedType(tag: DW_TAG_member, name: "func", scope: !65, file: !4, line: 507, baseType: !47, size: 64)
!68 = !DIDerivedType(tag: DW_TAG_member, name: "value", scope: !65, file: !4, line: 513, baseType: !46, size: 64, offset: 64)
!69 = !DIDerivedType(tag: DW_TAG_member, name: "coordinates", scope: !65, file: !4, line: 525, baseType: !70, size: 64, offset: 128)
!70 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !71, size: 64)
!71 = !DIDerivedType(tag: DW_TAG_typedef, name: "int32_t", file: !6, line: 11, baseType: !45)
!72 = !DIDerivedType(tag: DW_TAG_member, name: "trace_tag", scope: !65, file: !4, line: 530, baseType: !47, size: 64, offset: 192)
!73 = !DIDerivedType(tag: DW_TAG_member, name: "type", scope: !65, file: !4, line: 534, baseType: !74, size: 32, offset: 256)
...
!81 = !{null, !82, !29, !5, !30}
!82 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !74, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
...
!105 = !DIDerivedType(tag: DW_TAG_member, name: "event", scope: !65, file: !4, line: 537, baseType: !14, size: 32, offset: 288)
!106 = !DIDerivedType(tag: DW_TAG_member, name: "parent_id", scope: !65, file: !4, line: 541, baseType: !71, size: 32, offset: 320)
!107 = !DIDerivedType(tag: DW_TAG_member, name: "value_index", scope: !65, file: !4, line: 545, baseType: !71, size: 32, offset: 352)
!108 = !DIDerivedType(tag: DW_TAG_member, name: "dimensions", scope: !65, file: !4, line: 548, baseType: !71, size: 32, offset: 384)
...
!111 = !{null, !112}
!112 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !65, size: 64, flags: DIFlagArtificial | DIFlagObjectPointer)
...
!118 = !{!116}
!119 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !65, size: 64)
...
!124 = !{!122}
!125 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !74, size: 64)
...
!133 = !{!134, !135, i64 0}
!134 = !{!"_ZTS20halide_trace_event_t", !135, i64 0, !135, i64 8, !135, i64 16, !135, i64 24, !138, i64 32, !141, i64 36, !142, i64 40, !142, i64 44, !142, i64 48}
...
!180 = !DILocation(line: 28, column: 76, scope: !41)
!181 = !DILocation(line: 28, column: 87, scope: !41)
