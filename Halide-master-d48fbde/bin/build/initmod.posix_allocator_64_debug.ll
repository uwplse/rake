...
@_ZN6Halide7Runtime8Internal13custom_mallocE = weak dso_local local_unnamed_addr global i8* (i8*, i64)* @halide_default_malloc, align 8, !dbg !0
@_ZN6Halide7Runtime8Internal11custom_freeE = weak dso_local local_unnamed_addr global void (i8*, i8*)* @halide_default_free, align 8, !dbg !15

; Function Attrs: nounwind mustprogress
define weak dso_local i8* @halide_default_malloc(i8* %0, i64 %1) #0 !dbg !33 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !35, metadata !DIExpression()), !dbg !41
  call void @llvm.dbg.value(metadata i64 %1, metadata !36, metadata !DIExpression()), !dbg !41
  %3 = tail call i32 @halide_malloc_alignment() #4, !dbg !42
  %4 = sext i32 %3 to i64, !dbg !42
  call void @llvm.dbg.value(metadata i64 %4, metadata !37, metadata !DIExpression()), !dbg !41
  %5 = add i64 %4, %1, !dbg !43
  %6 = tail call i8* @malloc(i64 %5) #4, !dbg !44
  call void @llvm.dbg.value(metadata i8* %6, metadata !39, metadata !DIExpression()), !dbg !41
  %7 = icmp eq i8* %6, null, !dbg !45
  br i1 %7, label %17, label %8, !dbg !47

8:                                                ; preds = %2
  %9 = ptrtoint i8* %6 to i64, !dbg !48
  %10 = add nsw i64 %4, 7, !dbg !49
  %11 = add i64 %10, %9, !dbg !50
  %12 = sub nsw i64 0, %4, !dbg !51
  %13 = and i64 %11, %12, !dbg !52
  %14 = inttoptr i64 %13 to i8*, !dbg !53
  call void @llvm.dbg.value(metadata i8* %14, metadata !40, metadata !DIExpression()), !dbg !41
  %15 = inttoptr i64 %13 to i8**, !dbg !54
  %16 = getelementptr inbounds i8*, i8** %15, i64 -1, !dbg !55
  store i8* %6, i8** %16, align 8, !dbg !56, !tbaa !57
  br label %17

17:                                               ; preds = %2, %8
  %18 = phi i8* [ %14, %8 ], [ null, %2 ], !dbg !41
  ret i8* %18, !dbg !61
}

declare !dbg !62 extern_weak dso_local i32 @halide_malloc_alignment() local_unnamed_addr #1

declare !dbg !66 dso_local i8* @malloc(i64) local_unnamed_addr #1
...
define weak dso_local void @halide_default_free(i8* %0, i8* %1) #0 !dbg !69 {
  ...
  %3 = getelementptr inbounds i8, i8* %1, i64 -8, !dbg !74
  %4 = bitcast i8* %3 to i8**, !dbg !74
  %5 = load i8*, i8** %4, align 8, !dbg !74, !tbaa !57
...
define weak dso_local i8* (i8*, i64)* @halide_set_custom_malloc(i8* (i8*, i64)* %0) local_unnamed_addr #2 !dbg !80 {
  call void @llvm.dbg.value(metadata i8* (i8*, i64)* %0, metadata !84, metadata !DIExpression()), !dbg !86
  %2 = load i8* (i8*, i64)*, i8* (i8*, i64)** @_ZN6Halide7Runtime8Internal13custom_mallocE, align 8, !dbg !87, !tbaa !57
  call void @llvm.dbg.value(metadata i8* (i8*, i64)* %2, metadata !85, metadata !DIExpression()), !dbg !86
  store i8* (i8*, i64)* %0, i8* (i8*, i64)** @_ZN6Halide7Runtime8Internal13custom_mallocE, align 8, !dbg !88, !tbaa !57
  ret i8* (i8*, i64)* %2, !dbg !89
}
...
define weak dso_local void (i8*, i8*)* @halide_set_custom_free(void (i8*, i8*)* %0) local_unnamed_addr #2 !dbg !90 {
  ...
  %2 = load void (i8*, i8*)*, void (i8*, i8*)** @_ZN6Halide7Runtime8Internal11custom_freeE, align 8, !dbg !97, !tbaa !57
  call void @llvm.dbg.value(metadata void (i8*, i8*)* %2, metadata !95, metadata !DIExpression()), !dbg !96
  store void (i8*, i8*)* %0, void (i8*, i8*)** @_ZN6Halide7Runtime8Internal11custom_freeE, align 8, !dbg !98, !tbaa !57
  ret void (i8*, i8*)* %2, !dbg !99
}

; Function Attrs: nounwind mustprogress
define weak dso_local i8* @halide_malloc(i8* %0, i64 %1) local_unnamed_addr #0 !dbg !100 {
  ...
  %3 = load i8* (i8*, i64)*, i8* (i8*, i64)** @_ZN6Halide7Runtime8Internal13custom_mallocE, align 8, !dbg !105, !tbaa !57
  %4 = tail call i8* %3(i8* %0, i64 %1) #4, !dbg !105
  ret i8* %4, !dbg !106
}
...
define weak dso_local void @halide_free(i8* %0, i8* %1) local_unnamed_addr #0 !dbg !107 {
  ...
  %3 = load void (i8*, i8*)*, void (i8*, i8*)** @_ZN6Halide7Runtime8Internal11custom_freeE, align 8, !dbg !112, !tbaa !57
