...
define weak dso_local i8* @pseudostack_alloc(i8* %0, %struct.halide_pseudostack_slot_t* %1, i32 %2) #0 !dbg !22 {
  ...
  %4 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %1, i32 0, i32 1, !dbg !31
  %5 = load i32, i32* %4, align 4, !dbg !31, !tbaa !33
  %6 = icmp ult i32 %5, %2, !dbg !39
  %7 = getelementptr inbounds %struct.halide_pseudostack_slot_t, %struct.halide_pseudostack_slot_t* %1, i32 0, i32 0
  %8 = load i8*, i8** %7, align 4, !dbg !30, !tbaa !40
...
12:                                               ; preds = %11, %9
  %13 = tail call i8* @halide_malloc(i8* %0, i32 %2) #3, !dbg !50
  store i8* %13, i8** %7, align 4, !dbg !51, !tbaa !40
  store i32 %2, i32* %4, align 4, !dbg !52, !tbaa !33
  br label %14, !dbg !53
...
declare !dbg !60 dso_local i8* @halide_malloc(i8*, i32) local_unnamed_addr #1
...
define weak dso_local void @pseudostack_free(i8* %0, i8* %1) #0 !dbg !63 {
  ...
  %3 = getelementptr inbounds i8, i8* %1, i32 4, !dbg !69
  %4 = bitcast i8* %3 to i32*, !dbg !69
  store i32 0, i32* %4, align 4, !dbg !70, !tbaa !33
  %5 = bitcast i8* %1 to i8**, !dbg !71
  %6 = load i8*, i8** %5, align 4, !dbg !71, !tbaa !40
...
9:                                                ; preds = %8, %2
  store i8* null, i8** %5, align 4, !dbg !78, !tbaa !40
  ret void, !dbg !79
}
...
!5 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "halide_pseudostack_slot_t", file: !6, line: 180, size: 64, flags: DIFlagTypePassByValue, elements: !7, identifier: "_ZTS25halide_pseudostack_slot_t")
!6 = !DIFile(filename: "src/runtime/runtime_internal.h", directory: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde")
!7 = !{!8, !10}
!8 = !DIDerivedType(tag: DW_TAG_member, name: "ptr", scope: !5, file: !6, line: 181, baseType: !9, size: 32)
!9 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: null, size: 32)
!10 = !DIDerivedType(tag: DW_TAG_member, name: "size", scope: !5, file: !6, line: 182, baseType: !11, size: 32, offset: 32)
...
!33 = !{!34, !38, i64 4}
!34 = !{!"_ZTS25halide_pseudostack_slot_t", !35, i64 0, !38, i64 4}
