...
@__stack_chk_guard = weak dso_local local_unnamed_addr global i8* inttoptr (i32 -559038737 to i8*), align 4, !dbg !0
...
define weak dso_local void @__stack_chk_fail() local_unnamed_addr #0 !dbg !19 {
  tail call void @halide_error(i8* null, i8* getelementptr inbounds ([49 x i8], [49 x i8]* @.str, i32 0, i32 0)) #2, !dbg !22
