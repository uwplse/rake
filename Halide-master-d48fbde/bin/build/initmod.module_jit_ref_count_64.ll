...
@halide_jit_module_argument = weak local_unnamed_addr global i8* null, align 8
@halide_jit_module_adjust_ref_count = weak local_unnamed_addr global void (i8*, i32)* null, align 8

; Function Attrs: nounwind mustprogress
define weak void @halide_use_jit_module() local_unnamed_addr #0 {
  %1 = load void (i8*, i32)*, void (i8*, i32)** @halide_jit_module_adjust_ref_count, align 8, !tbaa !3
  %2 = icmp eq void (i8*, i32)* %1, null
  br i1 %2, label %5, label %3

3:                                                ; preds = %0
  %4 = load i8*, i8** @halide_jit_module_argument, align 8, !tbaa !3
