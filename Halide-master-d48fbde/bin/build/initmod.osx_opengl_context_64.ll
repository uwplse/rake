...
@_ZN6Halide7Runtime8Internal6OpenGL19cgl_functions_mutexE = weak global %struct.halide_mutex zeroinitializer, align 8
@_ZN6Halide7Runtime8Internal6OpenGL15cgl_initializedE = weak local_unnamed_addr global i8 0, align 1
@_ZN6Halide7Runtime8Internal6OpenGL20CGLChoosePixelFormatE = weak local_unnamed_addr global i32 (i32*, i8**, i32*)* null, align 8
@_ZN6Halide7Runtime8Internal6OpenGL16CGLCreateContextE = weak local_unnamed_addr global i32 (i8*, i8*, i8**)* null, align 8
@_ZN6Halide7Runtime8Internal6OpenGL21CGLDestroyPixelFormatE = weak local_unnamed_addr global i32 (i8*)* null, align 8
@_ZN6Halide7Runtime8Internal6OpenGL20CGLSetCurrentContextE = weak local_unnamed_addr global i32 (i8*)* null, align 8
@_ZZ30halide_opengl_get_proc_addressE5dylib = internal unnamed_addr global i8* null, align 8
...
define weak i8* @halide_opengl_get_proc_address(i8* %0, i8* %1) local_unnamed_addr #0 {
  %3 = load i8*, i8** @_ZZ30halide_opengl_get_proc_addressE5dylib, align 8, !tbaa !3
  %4 = icmp eq i8* %3, null
  br i1 %4, label %5, label %8

5:                                                ; preds = %2
  %6 = tail call i8* @halide_load_library(i8* getelementptr inbounds ([68 x i8], [68 x i8]* @.str, i64 0, i64 0)) #4
  store i8* %6, i8** @_ZZ30halide_opengl_get_proc_addressE5dylib, align 8, !tbaa !3
  %7 = icmp eq i8* %6, null
...
8:                                                ; preds = %1
  %9 = tail call i8* @halide_opengl_get_proc_address(i8* %0, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i64 0, i64 0)) #5
  store i8* %9, i8** bitcast (i32 (i32*, i8**, i32*)** @_ZN6Halide7Runtime8Internal6OpenGL20CGLChoosePixelFormatE to i8**), align 8, !tbaa !3
  %10 = icmp eq i8* %9, null
  br i1 %10, label %29, label %11

11:                                               ; preds = %8
  %12 = tail call i8* @halide_opengl_get_proc_address(i8* %0, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i64 0, i64 0)) #5
  store i8* %12, i8** bitcast (i32 (i8*, i8*, i8**)** @_ZN6Halide7Runtime8Internal6OpenGL16CGLCreateContextE to i8**), align 8, !tbaa !3
  %13 = icmp eq i8* %12, null
  br i1 %13, label %29, label %14

14:                                               ; preds = %11
  %15 = tail call i8* @halide_opengl_get_proc_address(i8* %0, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.3, i64 0, i64 0)) #5
  store i8* %15, i8** bitcast (i32 (i8*)** @_ZN6Halide7Runtime8Internal6OpenGL21CGLDestroyPixelFormatE to i8**), align 8, !tbaa !3
  %16 = icmp eq i8* %15, null
  br i1 %16, label %29, label %17

17:                                               ; preds = %14
  %18 = tail call i8* @halide_opengl_get_proc_address(i8* %0, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i64 0, i64 0)) #5
  store i8* %18, i8** bitcast (i32 (i8*)** @_ZN6Halide7Runtime8Internal6OpenGL20CGLSetCurrentContextE to i8**), align 8, !tbaa !3
...
20:                                               ; preds = %17, %1
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(20) %22, i8* nonnull align 4 dereferenceable(20) bitcast ([5 x i32]* @__const.halide_opengl_create_context.attribs to i8*), i64 20, i1 false)
  ...
  %25 = load i32 (i32*, i8**, i32*)*, i32 (i32*, i8**, i32*)** @_ZN6Halide7Runtime8Internal6OpenGL20CGLChoosePixelFormatE, align 8, !tbaa !3
...
30:                                               ; preds = %20
  %31 = load i32 (i8*, i8*, i8**)*, i32 (i8*, i8*, i8**)** @_ZN6Halide7Runtime8Internal6OpenGL16CGLCreateContextE, align 8, !tbaa !3
...
35:                                               ; preds = %30
  %36 = load i32 (i8*)*, i32 (i8*)** @_ZN6Halide7Runtime8Internal6OpenGL21CGLDestroyPixelFormatE, align 8, !tbaa !3
  %37 = load i8*, i8** %4, align 8, !tbaa !3
  %38 = call i32 %36(i8* %37) #4
  br label %43

39:                                               ; preds = %30
  %40 = load i32 (i8*)*, i32 (i8*)** @_ZN6Halide7Runtime8Internal6OpenGL20CGLSetCurrentContextE, align 8, !tbaa !3
