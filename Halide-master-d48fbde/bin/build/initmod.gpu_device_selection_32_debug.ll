...
10:                                               ; preds = %5
  %11 = tail call i8* @getenv(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0)) #4, !dbg !84
...
!11 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ScopedSpinLock", scope: !2, file: !10, line: 9, size: 32, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !12, identifier: "_ZTSN6Halide7Runtime8Internal14ScopedSpinLockE")
!12 = !{!13, !17, !21}
!13 = !DIDerivedType(tag: DW_TAG_member, name: "flag", scope: !11, file: !10, line: 13, baseType: !14, size: 32)
...
!19 = !{null, !20, !15}
!20 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !11, size: 32, flags: DIFlagArtificial | DIFlagObjectPointer)
...
!71 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !11, size: 32)
...
!105 = !{!106, !64}
!106 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !24, size: 32)
