...
define weak dso_local i64 @halide_current_time_ns(i8* %0) local_unnamed_addr #0 !dbg !63 {
  ...
  %5 = load i32, i32* getelementptr inbounds (%struct.mach_timebase_info, %struct.mach_timebase_info* @_ZN6Halide7Runtime8Internal20halide_timebase_infoE, i32 0, i32 0), align 4, !dbg !75, !tbaa !76
  %6 = zext i32 %5 to i64, !dbg !79
  %7 = mul i64 %4, %6, !dbg !80
  %8 = load i32, i32* getelementptr inbounds (%struct.mach_timebase_info, %struct.mach_timebase_info* @_ZN6Halide7Runtime8Internal20halide_timebase_infoE, i32 0, i32 1), align 4, !dbg !81, !tbaa !82
...
!58 = !{!34, !59}
!59 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !15, size: 32)
