; ModuleID = '/media/maaz/Data/Repos/rake/Halide-master-d48fbde/src/runtime/aarch64_cpu_features.cpp'
source_filename = "/media/maaz/Data/Repos/rake/Halide-master-d48fbde/src/runtime/aarch64_cpu_features.cpp"
...
define weak dso_local void @_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv(%"struct.Halide::Runtime::Internal::CpuFeatures"* noalias sret(%"struct.Halide::Runtime::Internal::CpuFeatures") align 8 %0) local_unnamed_addr #0 !dbg !42 {
  ...
  call void @llvm.dbg.value(metadata i32 0, metadata !48, metadata !DIExpression()), !dbg !54
  %2 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i32 0, i32 0, i32 0, !dbg !55
  store i64 0, i64* %2, align 8, !dbg !58, !tbaa !59
  %3 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i32 0, i32 1, i32 0, !dbg !63
  store i64 0, i64* %3, align 8, !dbg !64, !tbaa !59
  call void @llvm.dbg.value(metadata i32 1, metadata !48, metadata !DIExpression()), !dbg !54
  call void @llvm.dbg.value(metadata i32 1, metadata !48, metadata !DIExpression()), !dbg !54
  %4 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i32 0, i32 0, i32 1, !dbg !55
  store i64 0, i64* %4, align 8, !dbg !58, !tbaa !59
  %5 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i32 0, i32 1, i32 1, !dbg !63
...
!1 = !DIFile(filename: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde/src/runtime/aarch64_cpu_features.cpp", directory: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde")
!2 = !{}
!3 = !{!4}
...
!23 = !{null, !24, !12}
!24 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4, size: 32, flags: DIFlagArtificial | DIFlagObjectPointer)
...
!30 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !31, size: 32, flags: DIFlagArtificial | DIFlagObjectPointer)
...
!43 = !DIFile(filename: "src/runtime/aarch64_cpu_features.cpp", directory: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde")
...
!51 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !4, size: 32)
