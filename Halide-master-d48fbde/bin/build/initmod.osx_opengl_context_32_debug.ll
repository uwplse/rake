...
@_ZN6Halide7Runtime8Internal6OpenGL19cgl_functions_mutexE = weak dso_local global %struct.halide_mutex zeroinitializer, align 4, !dbg !0
@_ZN6Halide7Runtime8Internal6OpenGL15cgl_initializedE = weak dso_local local_unnamed_addr global i8 0, align 1, !dbg !18
@_ZN6Halide7Runtime8Internal6OpenGL20CGLChoosePixelFormatE = weak dso_local local_unnamed_addr global i32 (i32*, i8**, i32*)* null, align 4, !dbg !21
@_ZN6Halide7Runtime8Internal6OpenGL16CGLCreateContextE = weak dso_local local_unnamed_addr global i32 (i8*, i8*, i8**)* null, align 4, !dbg !30
@_ZN6Halide7Runtime8Internal6OpenGL21CGLDestroyPixelFormatE = weak dso_local local_unnamed_addr global i32 (i8*)* null, align 4, !dbg !35
@_ZN6Halide7Runtime8Internal6OpenGL20CGLSetCurrentContextE = weak dso_local local_unnamed_addr global i32 (i8*)* null, align 4, !dbg !40
@_ZZ30halide_opengl_get_proc_addressE5dylib = internal unnamed_addr global i8* null, align 4, !dbg !42
...
define weak dso_local i8* @halide_opengl_get_proc_address(i8* %0, i8* %1) local_unnamed_addr #0 !dbg !44 {
  ...
  %3 = load i8*, i8** @_ZZ30halide_opengl_get_proc_addressE5dylib, align 4, !dbg !66, !tbaa !68
  %4 = icmp eq i8* %3, null, !dbg !66
  br i1 %4, label %5, label %8, !dbg !72

5:                                                ; preds = %2
  %6 = tail call i8* @halide_load_library(i8* getelementptr inbounds ([68 x i8], [68 x i8]* @.str, i32 0, i32 0)) #5, !dbg !73
  store i8* %6, i8** @_ZZ30halide_opengl_get_proc_addressE5dylib, align 4, !dbg !75, !tbaa !68
...
8:                                                ; preds = %1
  %9 = tail call i8* @halide_opengl_get_proc_address(i8* %0, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i32 0, i32 0)) #7, !dbg !128
  store i8* %9, i8** bitcast (i32 (i32*, i8**, i32*)** @_ZN6Halide7Runtime8Internal6OpenGL20CGLChoosePixelFormatE to i8**), align 4, !dbg !131, !tbaa !68
  %10 = icmp eq i8* %9, null, !dbg !132
  br i1 %10, label %29, label %11, !dbg !133

11:                                               ; preds = %8
  %12 = tail call i8* @halide_opengl_get_proc_address(i8* %0, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i32 0, i32 0)) #7, !dbg !134
  store i8* %12, i8** bitcast (i32 (i8*, i8*, i8**)** @_ZN6Halide7Runtime8Internal6OpenGL16CGLCreateContextE to i8**), align 4, !dbg !136, !tbaa !68
  %13 = icmp eq i8* %12, null, !dbg !137
  br i1 %13, label %29, label %14, !dbg !138

14:                                               ; preds = %11
  %15 = tail call i8* @halide_opengl_get_proc_address(i8* %0, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.3, i32 0, i32 0)) #7, !dbg !139
  store i8* %15, i8** bitcast (i32 (i8*)** @_ZN6Halide7Runtime8Internal6OpenGL21CGLDestroyPixelFormatE to i8**), align 4, !dbg !141, !tbaa !68
  %16 = icmp eq i8* %15, null, !dbg !142
  br i1 %16, label %29, label %17, !dbg !143

17:                                               ; preds = %14
  %18 = tail call i8* @halide_opengl_get_proc_address(i8* %0, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i32 0, i32 0)) #7, !dbg !144
  store i8* %18, i8** bitcast (i32 (i8*)** @_ZN6Halide7Runtime8Internal6OpenGL20CGLSetCurrentContextE to i8**), align 4, !dbg !146, !tbaa !68
...
20:                                               ; preds = %17, %1
  ...
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %21) #6, !dbg !157
  call void @llvm.dbg.value(metadata i8* null, metadata !104, metadata !DIExpression()), !dbg !111
  store i8* null, i8** %2, align 4, !dbg !158, !tbaa !68
  ...
  call void @llvm.memcpy.p0i8.p0i8.i32(i8* nonnull align 4 dereferenceable(20) %22, i8* nonnull align 4 dereferenceable(20) bitcast ([5 x i32]* @__const.halide_opengl_create_context.attribs to i8*), i32 20, i1 false), !dbg !160
  %23 = bitcast i8** %4 to i8*, !dbg !161
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %23) #6, !dbg !161
  ...
  %25 = load i32 (i32*, i8**, i32*)*, i32 (i32*, i8**, i32*)** @_ZN6Halide7Runtime8Internal6OpenGL20CGLChoosePixelFormatE, align 4, !dbg !166, !tbaa !68
  %26 = getelementptr inbounds [5 x i32], [5 x i32]* %3, i32 0, i32 0, !dbg !168
...
30:                                               ; preds = %20
  %31 = load i32 (i8*, i8*, i8**)*, i32 (i8*, i8*, i8**)** @_ZN6Halide7Runtime8Internal6OpenGL16CGLCreateContextE, align 4, !dbg !174, !tbaa !68
  %32 = load i8*, i8** %4, align 4, !dbg !176, !tbaa !68
...
35:                                               ; preds = %30
  %36 = load i32 (i8*)*, i32 (i8*)** @_ZN6Halide7Runtime8Internal6OpenGL21CGLDestroyPixelFormatE, align 4, !dbg !179, !tbaa !68
  %37 = load i8*, i8** %4, align 4, !dbg !181, !tbaa !68
  call void @llvm.dbg.value(metadata i8* %37, metadata !109, metadata !DIExpression()), !dbg !111
  %38 = call i32 %36(i8* %37) #5, !dbg !179
  br label %43, !dbg !182

39:                                               ; preds = %30
  %40 = load i32 (i8*)*, i32 (i8*)** @_ZN6Halide7Runtime8Internal6OpenGL20CGLSetCurrentContextE, align 4, !dbg !183, !tbaa !68
  %41 = load i8*, i8** %2, align 4, !dbg !184, !tbaa !68
...
43:                                               ; preds = %20, %39, %35
  ...
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %23) #6, !dbg !186
  call void @llvm.lifetime.end.p0i8(i64 20, i8* nonnull %22) #6, !dbg !186
  call void @llvm.lifetime.end.p0i8(i64 4, i8* nonnull %21) #6, !dbg !186
  br label %45
...
!7 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "halide_mutex", file: !8, line: 120, size: 32, flags: DIFlagTypePassByValue, elements: !9, identifier: "_ZTS12halide_mutex")
!8 = !DIFile(filename: "src/runtime/HalideRuntime.h", directory: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde")
!9 = !{!10}
!10 = !DIDerivedType(tag: DW_TAG_member, name: "_private", scope: !7, file: !8, line: 121, baseType: !11, size: 32)
!11 = !DICompositeType(tag: DW_TAG_array_type, baseType: !12, size: 32, elements: !16)
!12 = !DIDerivedType(tag: DW_TAG_typedef, name: "uintptr_t", file: !13, line: 68, baseType: !14)
!13 = !DIFile(filename: "src/runtime/runtime_internal.h", directory: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde")
!14 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint32_t", file: !13, line: 12, baseType: !15)
...
!27 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !26, size: 32)
...
!92 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "ScopedMutexLock", scope: !3, file: !93, line: 11, size: 32, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !94, identifier: "_ZTSN6Halide7Runtime8Internal15ScopedMutexLockE")
!93 = !DIFile(filename: "src/runtime/scoped_mutex_lock.h", directory: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde")
!94 = !{!95, !97, !101}
!95 = !DIDerivedType(tag: DW_TAG_member, name: "mutex", scope: !92, file: !93, line: 12, baseType: !96, size: 32)
!96 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !7, size: 32)
...
!99 = !{null, !100, !96}
!100 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !92, size: 32, flags: DIFlagArtificial | DIFlagObjectPointer)
...
!116 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !92, size: 32)
