...
@halide_jit_module_argument = weak dso_local local_unnamed_addr global i8* null, align 4, !dbg !0
@halide_jit_module_adjust_ref_count = weak dso_local local_unnamed_addr global void (i8*, i32)* null, align 4, !dbg !6

; Function Attrs: nounwind mustprogress
define weak dso_local void @halide_use_jit_module() local_unnamed_addr #0 !dbg !25 {
  %1 = load void (i8*, i32)*, void (i8*, i32)** @halide_jit_module_adjust_ref_count, align 4, !dbg !28, !tbaa !30
  %2 = icmp eq void (i8*, i32)* %1, null, !dbg !34
  br i1 %2, label %5, label %3, !dbg !35

3:                                                ; preds = %0
  %4 = load i8*, i8** @halide_jit_module_argument, align 4, !dbg !36, !tbaa !30
...
define weak dso_local void @halide_release_jit_module() local_unnamed_addr #0 !dbg !40 {
  %1 = load void (i8*, i32)*, void (i8*, i32)** @halide_jit_module_adjust_ref_count, align 4, !dbg !41, !tbaa !30
  %2 = icmp eq void (i8*, i32)* %1, null, !dbg !43
  br i1 %2, label %5, label %3, !dbg !44

3:                                                ; preds = %0
  %4 = load i8*, i8** @halide_jit_module_argument, align 4, !dbg !45, !tbaa !30
