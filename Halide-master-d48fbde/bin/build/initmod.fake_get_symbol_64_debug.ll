...
define weak dso_local i8* @halide_default_get_symbol(i8* %0) #0 !dbg !35 {
  ...
  tail call void @halide_error(i8* null, i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str, i64 0, i64 0)) #4, !dbg !39
  ret i8* null, !dbg !40
}
...
define weak dso_local i8* @halide_default_load_library(i8* %0) #0 !dbg !44 {
  ...
  tail call void @halide_error(i8* null, i8* getelementptr inbounds ([62 x i8], [62 x i8]* @.str.1, i64 0, i64 0)) #4, !dbg !48
  ret i8* null, !dbg !49
}
...
define weak dso_local i8* @halide_default_get_library_symbol(i8* %0, i8* %1) #0 !dbg !50 {
  ...
  tail call void @halide_error(i8* null, i8* getelementptr inbounds ([68 x i8], [68 x i8]* @.str.2, i64 0, i64 0)) #4, !dbg !55
  ret i8* null, !dbg !56
}
...
define weak dso_local i8* (i8*)* @halide_set_custom_get_symbol(i8* (i8*)* %0) local_unnamed_addr #2 !dbg !57 {
  ...
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal17custom_get_symbolE, align 8, !dbg !64, !tbaa !65
  call void @llvm.dbg.value(metadata i8* (i8*)* %2, metadata !62, metadata !DIExpression()), !dbg !63
  store i8* (i8*)* %0, i8* (i8*)** @_ZN6Halide7Runtime8Internal17custom_get_symbolE, align 8, !dbg !69, !tbaa !65
  ret i8* (i8*)* %2, !dbg !70
}
...
define weak dso_local i8* (i8*)* @halide_set_custom_load_library(i8* (i8*)* %0) local_unnamed_addr #2 !dbg !71 {
  ...
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal19custom_load_libraryE, align 8, !dbg !78, !tbaa !65
  call void @llvm.dbg.value(metadata i8* (i8*)* %2, metadata !76, metadata !DIExpression()), !dbg !77
  store i8* (i8*)* %0, i8* (i8*)** @_ZN6Halide7Runtime8Internal19custom_load_libraryE, align 8, !dbg !79, !tbaa !65
  ret i8* (i8*)* %2, !dbg !80
}
...
define weak dso_local i8* (i8*, i8*)* @halide_set_custom_get_library_symbol(i8* (i8*, i8*)* %0) local_unnamed_addr #2 !dbg !81 {
  ...
  %2 = load i8* (i8*, i8*)*, i8* (i8*, i8*)** @_ZN6Halide7Runtime8Internal25custom_get_library_symbolE, align 8, !dbg !88, !tbaa !65
  call void @llvm.dbg.value(metadata i8* (i8*, i8*)* %2, metadata !86, metadata !DIExpression()), !dbg !87
  store i8* (i8*, i8*)* %0, i8* (i8*, i8*)** @_ZN6Halide7Runtime8Internal25custom_get_library_symbolE, align 8, !dbg !89, !tbaa !65
...
define weak dso_local i8* @halide_get_symbol(i8* %0) local_unnamed_addr #0 !dbg !91 {
  ...
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal17custom_get_symbolE, align 8, !dbg !95, !tbaa !65
...
define weak dso_local i8* @halide_load_library(i8* %0) local_unnamed_addr #0 !dbg !97 {
  ...
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal19custom_load_libraryE, align 8, !dbg !101, !tbaa !65
...
define weak dso_local i8* @halide_get_library_symbol(i8* %0, i8* %1) local_unnamed_addr #0 !dbg !103 {
  ...
  %3 = load i8* (i8*, i8*)*, i8* (i8*, i8*)** @_ZN6Halide7Runtime8Internal25custom_get_library_symbolE, align 8, !dbg !108, !tbaa !65
