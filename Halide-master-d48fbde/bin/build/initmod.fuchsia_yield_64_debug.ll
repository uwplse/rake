...
define weak dso_local void @halide_thread_yield() local_unnamed_addr #0 !dbg !13 {
  %1 = tail call i32 @zx_nanosleep(i64 0) #2, !dbg !17
  ret void, !dbg !18
}

declare !dbg !19 dso_local i32 @zx_nanosleep(i64) local_unnamed_addr #1
...
!1 = !DIFile(filename: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde/src/runtime/fuchsia_yield.cpp", directory: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde")
!2 = !{}
!3 = !{!4}
...
!13 = distinct !DISubprogram(name: "halide_thread_yield", scope: !14, file: !14, line: 7, type: !15, scopeLine: 7, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !2)
!14 = !DIFile(filename: "src/runtime/fuchsia_yield.cpp", directory: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde")
!15 = !DISubroutineType(types: !16)
!16 = !{null}
!17 = !DILocation(line: 8, column: 5, scope: !13)
!18 = !DILocation(line: 9, column: 1, scope: !13)
!19 = !DISubprogram(name: "zx_nanosleep", scope: !14, file: !14, line: 5, type: !20, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !2)
