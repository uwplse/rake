...
define weak dso_local i32 @halide_profiler_set_current_func(%struct.halide_profiler_state* %0, i32 %1, i32 %2) local_unnamed_addr #0 !dbg !13 {
  ...
  %4 = getelementptr inbounds %struct.halide_profiler_state, %struct.halide_profiler_state* %0, i64 0, i32 3, !dbg !55
...
define weak dso_local i32 @halide_profiler_incr_active_threads(%struct.halide_profiler_state* %0) local_unnamed_addr #0 !dbg !67 {
  ...
  %2 = getelementptr inbounds %struct.halide_profiler_state, %struct.halide_profiler_state* %0, i64 0, i32 4, !dbg !75
...
define weak dso_local i32 @halide_profiler_decr_active_threads(%struct.halide_profiler_state* %0) local_unnamed_addr #0 !dbg !82 {
  ...
  %2 = getelementptr inbounds %struct.halide_profiler_state, %struct.halide_profiler_state* %0, i64 0, i32 4, !dbg !88
...
!19 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "halide_profiler_state", file: !20, line: 1766, size: 384, flags: DIFlagTypePassByValue, elements: !21, identifier: "_ZTS21halide_profiler_state")
...
!22 = !DIDerivedType(tag: DW_TAG_member, name: "lock", scope: !19, file: !20, line: 1770, baseType: !23, size: 64)
!23 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "halide_mutex", file: !20, line: 120, size: 64, flags: DIFlagTypePassByValue, elements: !24, identifier: "_ZTS12halide_mutex")
!24 = !{!25}
!25 = !DIDerivedType(tag: DW_TAG_member, name: "_private", scope: !23, file: !20, line: 121, baseType: !26, size: 64)
!26 = !DICompositeType(tag: DW_TAG_array_type, baseType: !27, size: 64, elements: !30)
!27 = !DIDerivedType(tag: DW_TAG_typedef, name: "uintptr_t", file: !8, line: 61, baseType: !28)
!28 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint64_t", file: !8, line: 10, baseType: !29)
!29 = !DIBasicType(name: "long long unsigned int", size: 64, encoding: DW_ATE_unsigned)
!30 = !{!31}
!31 = !DISubrange(count: 1)
!32 = !DIDerivedType(tag: DW_TAG_member, name: "sleep_time", scope: !19, file: !20, line: 1774, baseType: !17, size: 32, offset: 64)
!33 = !DIDerivedType(tag: DW_TAG_member, name: "first_free_id", scope: !19, file: !20, line: 1777, baseType: !17, size: 32, offset: 96)
!34 = !DIDerivedType(tag: DW_TAG_member, name: "current_func", scope: !19, file: !20, line: 1781, baseType: !17, size: 32, offset: 128)
!35 = !DIDerivedType(tag: DW_TAG_member, name: "active_threads", scope: !19, file: !20, line: 1784, baseType: !17, size: 32, offset: 160)
!36 = !DIDerivedType(tag: DW_TAG_member, name: "pipelines", scope: !19, file: !20, line: 1787, baseType: !37, size: 64, offset: 192)
!37 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !38, size: 64)
!38 = !DICompositeType(tag: DW_TAG_structure_type, name: "halide_profiler_pipeline_stats", file: !20, line: 1721, size: 768, flags: DIFlagFwdDecl, identifier: "_ZTS30halide_profiler_pipeline_stats")
!39 = !DIDerivedType(tag: DW_TAG_member, name: "get_remote_profiler_state", scope: !19, file: !20, line: 1792, baseType: !40, size: 64, offset: 256)
!40 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !41, size: 64)
!41 = !DISubroutineType(types: !42)
!42 = !{null, !43, !43}
!43 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !17, size: 64)
!44 = !DIDerivedType(tag: DW_TAG_member, name: "sampling_thread", scope: !19, file: !20, line: 1795, baseType: !45, size: 64, offset: 320)
