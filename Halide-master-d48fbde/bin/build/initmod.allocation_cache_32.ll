...
@_ZN6Halide7Runtime8Internal21allocation_pools_lockE = weak global %struct.halide_mutex zeroinitializer, align 4
@_ZN6Halide7Runtime8Internal23device_allocation_poolsE = weak local_unnamed_addr global %struct.halide_device_allocation_pool* null, align 4
...
4:                                                ; preds = %2
  ...
  %5 = load %struct.halide_device_allocation_pool*, %struct.halide_device_allocation_pool** @_ZN6Halide7Runtime8Internal23device_allocation_poolsE, align 4, !tbaa !7
...
9:                                                ; preds = %4, %9
  ...
  %11 = phi i32 [ %16, %9 ], [ 0, %4 ]
  %12 = getelementptr inbounds %struct.halide_device_allocation_pool, %struct.halide_device_allocation_pool* %10, i32 0, i32 0
  %13 = load i32 (i8*)*, i32 (i8*)** %12, align 4, !tbaa !9
  %14 = tail call i32 %13(i8* %0) #3
  %15 = icmp eq i32 %14, 0
  %16 = select i1 %15, i32 %11, i32 %14
  %17 = getelementptr inbounds %struct.halide_device_allocation_pool, %struct.halide_device_allocation_pool* %10, i32 0, i32 1
  %18 = load %struct.halide_device_allocation_pool*, %struct.halide_device_allocation_pool** %17, align 4, !tbaa !7
...
define weak void @halide_register_device_allocation_pool(%struct.halide_device_allocation_pool* %0) local_unnamed_addr #0 {
  tail call void @halide_mutex_lock(%struct.halide_mutex* nonnull @_ZN6Halide7Runtime8Internal21allocation_pools_lockE) #3
  %2 = load %struct.halide_device_allocation_pool*, %struct.halide_device_allocation_pool** @_ZN6Halide7Runtime8Internal23device_allocation_poolsE, align 4, !tbaa !7
  %3 = getelementptr inbounds %struct.halide_device_allocation_pool, %struct.halide_device_allocation_pool* %0, i32 0, i32 1
  store %struct.halide_device_allocation_pool* %2, %struct.halide_device_allocation_pool** %3, align 4, !tbaa !14
  store %struct.halide_device_allocation_pool* %0, %struct.halide_device_allocation_pool** @_ZN6Halide7Runtime8Internal23device_allocation_poolsE, align 4, !tbaa !7
  tail call void @halide_mutex_unlock(%struct.halide_mutex* nonnull @_ZN6Halide7Runtime8Internal21allocation_pools_lockE) #3
  ret void
}
...
!9 = !{!10, !8, i64 0}
!10 = !{!"_ZTS29halide_device_allocation_pool", !8, i64 0, !8, i64 4}
!11 = distinct !{!11, !12}
