...
4:                                                ; preds = %1
  %5 = tail call i8* @malloc(i64 1024) #5
  %6 = icmp eq i8* %5, null
  br i1 %6, label %7, label %9

7:                                                ; preds = %4
  %8 = tail call i8* @halide_string_to_string(i8* %5, i8* null, i8* nonnull getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4, i64 0, i64 0)) #5
  tail call void @halide_error(i8* %0, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7, i64 0, i64 0)) #5
  br label %17

9:                                                ; preds = %4
  %10 = getelementptr inbounds i8, i8* %5, i64 1023
  store i8 0, i8* %10, align 1, !tbaa !3
  %11 = tail call i8* @halide_string_to_string(i8* nonnull %5, i8* nonnull %10, i8* nonnull getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4, i64 0, i64 0)) #5
  %12 = ptrtoint i8* %11 to i64
  %13 = ptrtoint i8* %5 to i64
  %14 = add i64 %12, 1
  %15 = sub i64 %14, %13
  %16 = tail call i32 @halide_msan_annotate_memory_is_initialized(i8* %0, i8* nonnull %5, i64 %15) #5
...
7:                                                ; preds = %4
  %8 = tail call i8* @halide_string_to_string(i8* %5, i8* null, i8* nonnull getelementptr inbounds ([24 x i8], [24 x i8]* @.str.6, i64 0, i64 0)) #5
  tail call void @halide_error(i8* %0, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7, i64 0, i64 0)) #5
  br label %17
...
9:                                                ; preds = %4
  %10 = getelementptr inbounds i8, i8* %5, i64 1023
  store i8 0, i8* %10, align 1, !tbaa !3
  %11 = tail call i8* @halide_string_to_string(i8* nonnull %5, i8* nonnull %10, i8* nonnull getelementptr inbounds ([24 x i8], [24 x i8]* @.str.6, i64 0, i64 0)) #5
  %12 = ptrtoint i8* %11 to i64
  %13 = ptrtoint i8* %5 to i64
  %14 = add i64 %12, 1
  %15 = sub i64 %14, %13
...
define weak i8* @_halide_hexagon_buffer_get_host(%struct.hexagon_buffer_t_arg* %0) local_unnamed_addr #4 {
  %2 = getelementptr inbounds %struct.hexagon_buffer_t_arg, %struct.hexagon_buffer_t_arg* %0, i64 0, i32 1
...
define weak i64 @_halide_hexagon_buffer_get_device(%struct.hexagon_buffer_t_arg* %0) local_unnamed_addr #4 {
  %2 = getelementptr inbounds %struct.hexagon_buffer_t_arg, %struct.hexagon_buffer_t_arg* %0, i64 0, i32 0
