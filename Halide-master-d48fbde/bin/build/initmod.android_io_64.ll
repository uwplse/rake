...
define weak void @halide_default_print(i8* %0, i8* %1) local_unnamed_addr #0 {
  %3 = tail call i32 (i32, i8*, i8*, ...) @__android_log_print(i32 4, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i64 0, i64 0), i8* %1) #2
  ret void
}
