...
define weak dso_local i8* @halide_default_load_library(i8* %0) #2 !dbg !177 {
  ...
  br i1 %3, label %4, label %30, !dbg !185
...
4:                                                ; preds = %1
  ...
  %5 = tail call i8* @malloc(i32 1024) #5, !dbg !195
  %6 = icmp eq i8* %5, null, !dbg !200
  br i1 %6, label %9, label %7, !dbg !202

7:                                                ; preds = %4
  %8 = getelementptr inbounds i8, i8* %5, i32 1023, !dbg !203
...
9:                                                ; preds = %4, %7
  ...
  call void @llvm.dbg.value(metadata i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), metadata !214, metadata !DIExpression()) #6, !dbg !215
  %11 = tail call i8* @halide_string_to_string(i8* %5, i8* %10, i8* nonnull getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0)) #5, !dbg !217
...
14:                                               ; preds = %9
  %15 = tail call i8* @halide_string_to_string(i8* %11, i8* %10, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.3, i32 0, i32 0)) #5, !dbg !225
  br label %18, !dbg !227
...
18:                                               ; preds = %14, %16
  ...
  call void @llvm.dbg.value(metadata i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0), metadata !214, metadata !DIExpression()) #6, !dbg !230
  %20 = tail call i8* @halide_string_to_string(i8* %19, i8* %10, i8* nonnull getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0)) #5, !dbg !232
...
21:                                               ; preds = %18
  tail call void @halide_error(i8* null, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i32 0, i32 0)) #5, !dbg !240
  br label %29, !dbg !243
...
22:                                               ; preds = %18
  ...
  %23 = ptrtoint i8* %20 to i32, !dbg !250
  %24 = ptrtoint i8* %5 to i32, !dbg !250
  %25 = add i32 %23, 1, !dbg !250
  %26 = sub i32 %25, %24, !dbg !251
  %27 = sext i32 %26 to i64, !dbg !252
  %28 = tail call i32 @halide_msan_annotate_memory_is_initialized(i8* null, i8* nonnull %5, i64 %27) #5, !dbg !253
  tail call void @halide_print(i8* null, i8* nonnull %5) #5, !dbg !254
  br label %29

29:                                               ; preds = %21, %22
  call void @free(i8* %5) #5, !dbg !258
  br label %30, !dbg !261
...
declare !dbg !263 dso_local i8* @dlopen(i8*, i32) local_unnamed_addr #1

declare !dbg !266 dso_local i8* @dlerror() local_unnamed_addr #1

; Function Attrs: nounwind mustprogress
define weak dso_local i8* @halide_default_get_library_symbol(i8* %0, i8* %1) #0 !dbg !269 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !271, metadata !DIExpression()), !dbg !273
  call void @llvm.dbg.value(metadata i8* %1, metadata !272, metadata !DIExpression()), !dbg !273
  %3 = tail call i8* @dlsym(i8* %0, i8* %1) #5, !dbg !274
  ret i8* %3, !dbg !275
}

; Function Attrs: nounwind willreturn mustprogress
define weak dso_local i8* (i8*)* @halide_set_custom_get_symbol(i8* (i8*)* %0) local_unnamed_addr #3 !dbg !276 {
  call void @llvm.dbg.value(metadata i8* (i8*)* %0, metadata !280, metadata !DIExpression()), !dbg !282
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal17custom_get_symbolE, align 4, !dbg !283, !tbaa !284
  call void @llvm.dbg.value(metadata i8* (i8*)* %2, metadata !281, metadata !DIExpression()), !dbg !282
  store i8* (i8*)* %0, i8* (i8*)** @_ZN6Halide7Runtime8Internal17custom_get_symbolE, align 4, !dbg !286, !tbaa !284
  ret i8* (i8*)* %2, !dbg !287
}

; Function Attrs: nounwind willreturn mustprogress
define weak dso_local i8* (i8*)* @halide_set_custom_load_library(i8* (i8*)* %0) local_unnamed_addr #3 !dbg !288 {
  call void @llvm.dbg.value(metadata i8* (i8*)* %0, metadata !292, metadata !DIExpression()), !dbg !294
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal19custom_load_libraryE, align 4, !dbg !295, !tbaa !284
  call void @llvm.dbg.value(metadata i8* (i8*)* %2, metadata !293, metadata !DIExpression()), !dbg !294
  store i8* (i8*)* %0, i8* (i8*)** @_ZN6Halide7Runtime8Internal19custom_load_libraryE, align 4, !dbg !296, !tbaa !284
  ret i8* (i8*)* %2, !dbg !297
}

; Function Attrs: nounwind willreturn mustprogress
define weak dso_local i8* (i8*, i8*)* @halide_set_custom_get_library_symbol(i8* (i8*, i8*)* %0) local_unnamed_addr #3 !dbg !298 {
  call void @llvm.dbg.value(metadata i8* (i8*, i8*)* %0, metadata !302, metadata !DIExpression()), !dbg !304
  %2 = load i8* (i8*, i8*)*, i8* (i8*, i8*)** @_ZN6Halide7Runtime8Internal25custom_get_library_symbolE, align 4, !dbg !305, !tbaa !284
  call void @llvm.dbg.value(metadata i8* (i8*, i8*)* %2, metadata !303, metadata !DIExpression()), !dbg !304
  store i8* (i8*, i8*)* %0, i8* (i8*, i8*)** @_ZN6Halide7Runtime8Internal25custom_get_library_symbolE, align 4, !dbg !306, !tbaa !284
  ret i8* (i8*, i8*)* %2, !dbg !307
}

; Function Attrs: nounwind mustprogress
define weak dso_local i8* @halide_get_symbol(i8* %0) local_unnamed_addr #0 !dbg !308 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !310, metadata !DIExpression()), !dbg !311
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal17custom_get_symbolE, align 4, !dbg !312, !tbaa !284
  %3 = tail call i8* %2(i8* %0) #5, !dbg !312
  ret i8* %3, !dbg !313
}

; Function Attrs: nounwind mustprogress
define weak dso_local i8* @halide_load_library(i8* %0) local_unnamed_addr #0 !dbg !314 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !316, metadata !DIExpression()), !dbg !317
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal19custom_load_libraryE, align 4, !dbg !318, !tbaa !284
  %3 = tail call i8* %2(i8* %0) #5, !dbg !318
  ret i8* %3, !dbg !319
}

; Function Attrs: nounwind mustprogress
define weak dso_local i8* @halide_get_library_symbol(i8* %0, i8* %1) local_unnamed_addr #0 !dbg !320 {
  call void @llvm.dbg.value(metadata i8* %0, metadata !322, metadata !DIExpression()), !dbg !324
  call void @llvm.dbg.value(metadata i8* %1, metadata !323, metadata !DIExpression()), !dbg !324
  %3 = load i8* (i8*, i8*)*, i8* (i8*, i8*)** @_ZN6Halide7Runtime8Internal25custom_get_library_symbolE, align 4, !dbg !325, !tbaa !284
  %4 = tail call i8* %3(i8* %0, i8* %1) #5, !dbg !325
  ret i8* %4, !dbg !326
}

declare !dbg !327 dso_local i8* @malloc(i32) local_unnamed_addr #1
...
!41 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "Printer<0, 1024>", scope: !40, file: !39, line: 30, size: 160, flags: DIFlagTypePassByReference | DIFlagNonTrivial, elements: !42, templateParams: !159)
!42 = !{!43, !45, !46, !47, !48, !50, !54, !58, !62, !67, !72, !77, !82, !86, !90, !95, !101, !134, !141, !144, !147, !152, !153, !156, !157, !158}
!43 = !DIDerivedType(tag: DW_TAG_member, name: "buf", scope: !41, file: !39, line: 32, baseType: !44, size: 32, flags: DIFlagPublic)
!44 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !14, size: 32)
!45 = !DIDerivedType(tag: DW_TAG_member, name: "dst", scope: !41, file: !39, line: 32, baseType: !44, size: 32, offset: 32, flags: DIFlagPublic)
!46 = !DIDerivedType(tag: DW_TAG_member, name: "end", scope: !41, file: !39, line: 32, baseType: !44, size: 32, offset: 64, flags: DIFlagPublic)
!47 = !DIDerivedType(tag: DW_TAG_member, name: "user_context", scope: !41, file: !39, line: 33, baseType: !11, size: 32, offset: 96, flags: DIFlagPublic)
!48 = !DIDerivedType(tag: DW_TAG_member, name: "own_mem", scope: !41, file: !39, line: 34, baseType: !49, size: 8, offset: 128, flags: DIFlagPublic)
!49 = !DIBasicType(name: "bool", size: 8, encoding: DW_ATE_boolean)
!50 = !DIDerivedType(tag: DW_TAG_member, name: "scratch", scope: !41, file: !39, line: 35, baseType: !51, size: 8, offset: 136, flags: DIFlagPublic)
...
!56 = !{null, !57, !11, !44}
!57 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !41, size: 32, flags: DIFlagArtificial | DIFlagObjectPointer)
...
!60 = !{!61, !57, !12}
!61 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !41, size: 32)
...
!103 = !{!61, !57, !104}
!104 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !105, size: 32)
...
!115 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !106, size: 32, flags: DIFlagArtificial | DIFlagObjectPointer)
...
!121 = !{!106, !122, !99}
!122 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !105, size: 32, flags: DIFlagArtificial | DIFlagObjectPointer)
...
!136 = !{!61, !57, !137}
!137 = !DIDerivedType(tag: DW_TAG_reference_type, baseType: !138, size: 32)
...
!140 = !DICompositeType(tag: DW_TAG_structure_type, name: "halide_buffer_t", file: !7, line: 1423, size: 320, flags: DIFlagFwdDecl | DIFlagNonTrivial, identifier: "_ZTS15halide_buffer_t")
...
!191 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !41, size: 32)
...
!252 = !DILocation(line: 163, column: 77, scope: !245, inlinedAt: !248)
!253 = !DILocation(line: 163, column: 15, scope: !245, inlinedAt: !248)
!254 = !DILocation(line: 174, column: 17, scope: !255, inlinedAt: !237)
!255 = distinct !DILexicalBlock(scope: !256, file: !39, line: 173, column: 46)
!256 = distinct !DILexicalBlock(scope: !257, file: !39, line: 173, column: 24)
!257 = distinct !DILexicalBlock(scope: !249, file: !39, line: 171, column: 17)
!258 = !DILocation(line: 181, column: 13, scope: !259, inlinedAt: !237)
!259 = distinct !DILexicalBlock(scope: !260, file: !39, line: 180, column: 40)
!260 = distinct !DILexicalBlock(scope: !239, file: !39, line: 180, column: 13)
!261 = !DILocation(line: 20, column: 5, scope: !194)
!262 = !DILocation(line: 21, column: 5, scope: !177)
!263 = !DISubprogram(name: "dlopen", scope: !5, file: !5, line: 6, type: !264, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !176)
!264 = !DISubroutineType(types: !265)
!265 = !{!11, !12, !71}
!266 = !DISubprogram(name: "dlerror", scope: !5, file: !5, line: 8, type: !267, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !176)
!267 = !DISubroutineType(types: !268)
!268 = !{!44}
!269 = distinct !DISubprogram(name: "halide_default_get_library_symbol", scope: !5, file: !5, line: 24, type: !22, scopeLine: 24, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !24, retainedNodes: !270)
!270 = !{!271, !272}
!271 = !DILocalVariable(name: "lib", arg: 1, scope: !269, file: !5, line: 24, type: !11)
!272 = !DILocalVariable(name: "name", arg: 2, scope: !269, file: !5, line: 24, type: !12)
!273 = !DILocation(line: 0, scope: !269)
!274 = !DILocation(line: 25, column: 12, scope: !269)
!275 = !DILocation(line: 25, column: 5, scope: !269)
!276 = distinct !DISubprogram(name: "halide_set_custom_get_symbol", scope: !5, file: !5, line: 44, type: !277, scopeLine: 44, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !24, retainedNodes: !279)
!277 = !DISubroutineType(types: !278)
!278 = !{!6, !6}
!279 = !{!280, !281}
!280 = !DILocalVariable(name: "f", arg: 1, scope: !276, file: !5, line: 44, type: !6)
!281 = !DILocalVariable(name: "result", scope: !276, file: !5, line: 45, type: !6)
!282 = !DILocation(line: 0, scope: !276)
!283 = !DILocation(line: 45, column: 34, scope: !276)
!284 = !{!285, !285, i64 0}
!285 = !{!"any pointer", !207, i64 0}
!286 = !DILocation(line: 46, column: 23, scope: !276)
!287 = !DILocation(line: 47, column: 5, scope: !276)
!288 = distinct !DISubprogram(name: "halide_set_custom_load_library", scope: !5, file: !5, line: 50, type: !289, scopeLine: 50, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !24, retainedNodes: !291)
!289 = !DISubroutineType(types: !290)
!290 = !{!17, !17}
!291 = !{!292, !293}
!292 = !DILocalVariable(name: "f", arg: 1, scope: !288, file: !5, line: 50, type: !17)
!293 = !DILocalVariable(name: "result", scope: !288, file: !5, line: 51, type: !17)
!294 = !DILocation(line: 0, scope: !288)
!295 = !DILocation(line: 51, column: 36, scope: !288)
!296 = !DILocation(line: 52, column: 25, scope: !288)
!297 = !DILocation(line: 53, column: 5, scope: !288)
!298 = distinct !DISubprogram(name: "halide_set_custom_get_library_symbol", scope: !5, file: !5, line: 56, type: !299, scopeLine: 56, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !24, retainedNodes: !301)
!299 = !DISubroutineType(types: !300)
!300 = !{!20, !20}
!301 = !{!302, !303}
!302 = !DILocalVariable(name: "f", arg: 1, scope: !298, file: !5, line: 56, type: !20)
!303 = !DILocalVariable(name: "result", scope: !298, file: !5, line: 57, type: !20)
!304 = !DILocation(line: 0, scope: !298)
!305 = !DILocation(line: 57, column: 42, scope: !298)
!306 = !DILocation(line: 58, column: 31, scope: !298)
!307 = !DILocation(line: 59, column: 5, scope: !298)
!308 = distinct !DISubprogram(name: "halide_get_symbol", scope: !5, file: !5, line: 62, type: !9, scopeLine: 62, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !24, retainedNodes: !309)
!309 = !{!310}
!310 = !DILocalVariable(name: "name", arg: 1, scope: !308, file: !5, line: 62, type: !12)
!311 = !DILocation(line: 0, scope: !308)
!312 = !DILocation(line: 63, column: 12, scope: !308)
!313 = !DILocation(line: 63, column: 5, scope: !308)
!314 = distinct !DISubprogram(name: "halide_load_library", scope: !5, file: !5, line: 66, type: !9, scopeLine: 66, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !24, retainedNodes: !315)
!315 = !{!316}
!316 = !DILocalVariable(name: "name", arg: 1, scope: !314, file: !5, line: 66, type: !12)
!317 = !DILocation(line: 0, scope: !314)
!318 = !DILocation(line: 67, column: 12, scope: !314)
!319 = !DILocation(line: 67, column: 5, scope: !314)
!320 = distinct !DISubprogram(name: "halide_get_library_symbol", scope: !5, file: !5, line: 70, type: !22, scopeLine: 70, flags: DIFlagPrototyped | DIFlagAllCallsDescribed, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !24, retainedNodes: !321)
!321 = !{!322, !323}
!322 = !DILocalVariable(name: "lib", arg: 1, scope: !320, file: !5, line: 70, type: !11)
!323 = !DILocalVariable(name: "name", arg: 2, scope: !320, file: !5, line: 70, type: !12)
!324 = !DILocation(line: 0, scope: !320)
!325 = !DILocation(line: 71, column: 12, scope: !320)
!326 = !DILocation(line: 71, column: 5, scope: !320)
!327 = !DISubprogram(name: "malloc", scope: !29, file: !29, line: 87, type: !328, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !176)
