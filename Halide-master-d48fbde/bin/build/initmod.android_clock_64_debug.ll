...
4:                                                ; preds = %1
  %5 = tail call i32 (i32, ...) @syscall(i32 113, i32 0, %struct.timespec* nonnull @halide_reference_clock) #4, !dbg !44
...
define weak dso_local i64 @halide_current_time_ns(i8* %0) local_unnamed_addr #0 !dbg !52 {
  ...
  %4 = call i32 (i32, ...) @syscall(i32 113, i32 0, %struct.timespec* nonnull %2) #4, !dbg !63
