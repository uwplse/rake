...
define weak i32 @halide_trace_helper(i8* %0, i8* %1, i8* %2, i32* %3, i32 %4, i32 %5, i32 %6, i32 %7, i32 %8, i32 %9, i32 %10, i8* %11) local_unnamed_addr #0 {
  ...
  call void @llvm.lifetime.start.p0i8(i64 56, i8* nonnull %14) #3
  ...
  store i8* %1, i8** %18, align 8, !tbaa !3
  ...
  store i32 %8, i32* %26, align 8, !tbaa !20
  ...
  store i32 %10, i32* %28, align 8, !tbaa !22
  %29 = call i32 @halide_msan_annotate_memory_is_initialized(i8* %0, i8* nonnull %14, i64 56) #4
  %30 = add nsw i32 %5, 7
  %31 = sdiv i32 %30, 8
  %32 = mul nsw i32 %31, %6
  ...
  call void @llvm.lifetime.end.p0i8(i64 56, i8* nonnull %14) #3
  ret i32 %39
}
