...
declare i64 @halide_cuda_get_device_ptr(i8*, %struct.halide_buffer_t*) #0

declare i32 @halide_cuda_initialize_kernels(i8*, i8**, i8*, i32) #0

declare void @halide_cuda_finalize_kernels(i8*, i8*) #0

declare i32 @halide_cuda_run(i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i64*, i8**, i8*, i32, float*, i32, i32) #0
...
declare i8* @halide_malloc(i8*, i64) #0
...
declare i64 @halide_metal_get_buffer(i8*, %struct.halide_buffer_t*) #0
...
declare i32 @halide_metal_run(i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i64*, i8**, i8*, i32, float*, i32, i32) #0
...
declare i64 @halide_opencl_get_cl_mem(i8*, %struct.halide_buffer_t*) #0
...
declare i32 @halide_opencl_run(i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i64*, i8**, i8*, i32, float*, i32, i32) #0
...
declare i8* (i8*, i64)* @halide_set_custom_malloc(i8* (i8*, i64)*) #0
