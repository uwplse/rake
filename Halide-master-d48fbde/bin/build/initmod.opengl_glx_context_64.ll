...
11:                                               ; preds = %8, %23
  %12 = phi i8* [ %24, %23 ], [ %9, %8 ]
  %13 = phi i8* [ %15, %23 ], [ %0, %8 ]
  %14 = tail call i64 @strlen(i8* nonnull %1) #3
...
11:                                               ; preds = %8
  tail call void @halide_error(i8* %0, i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str, i64 0, i64 0)) #3
  br label %57
...
15:                                               ; preds = %12
  tail call void @halide_error(i8* %0, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.1, i64 0, i64 0)) #3
  br label %57
...
16:                                               ; preds = %12
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(44) %18, i8* nonnull align 4 dereferenceable(44) bitcast ([11 x i32]* @__const.halide_opengl_create_context.attribs to i8*), i64 44, i1 false)
  %19 = bitcast i32* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 4, i8* nonnull %19) #4
  store i32 0, i32* %3, align 4, !tbaa !6
  %20 = getelementptr inbounds [11 x i32], [11 x i32]* %2, i64 0, i64 0
...
24:                                               ; preds = %16
  call void @halide_error(i8* %0, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0)) #3
  br label %55

25:                                               ; preds = %16
  %26 = load i8*, i8** %21, align 8, !tbaa !8
  %27 = call i8* @glXQueryExtensionsString(i8* nonnull %9, i32 %17) #3
  %28 = call void ()* @glXGetProcAddressARB(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.3, i64 0, i64 0)) #3
  %29 = call zeroext i1 @_ZN6Halide7Runtime8Internal23glx_extension_supportedEPKcS3_(i8* %27, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.4, i64 0, i64 0)) #5
...
32:                                               ; preds = %25
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(20) %34, i8* nonnull align 4 dereferenceable(20) bitcast ([5 x i32]* @__const.halide_opengl_create_context.context_attribs to i8*), i64 20, i1 false)
...
41:                                               ; preds = %38
  call void @halide_error(i8* %0, i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5, i64 0, i64 0)) #3
  br label %55
...
42:                                               ; preds = %32, %38
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* nonnull align 4 dereferenceable(20) %44, i8* nonnull align 4 dereferenceable(20) bitcast ([5 x i32]* @__const.halide_opengl_create_context.pbuffer_attribs to i8*), i64 20, i1 false)
  %45 = getelementptr inbounds [5 x i32], [5 x i32]* %5, i64 0, i64 0
  %46 = call i64 @glXCreatePbuffer(i8* nonnull %9, i8* %26, i32* nonnull %45) #3
  %47 = bitcast i8** %21 to i8*
  %48 = call i32 @XFree(i8* nonnull %47) #3
  %49 = call i32 @XSync(i8* nonnull %9, i32 0) #3
  %50 = call i32 @glXMakeContextCurrent(i8* nonnull %9, i64 %46, i64 %46, i8* nonnull %43) #3
  %51 = icmp eq i32 %50, 0
  br i1 %51, label %52, label %53

52:                                               ; preds = %42
  call void @halide_error(i8* %0, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.6, i64 0, i64 0)) #3
  br label %53
...
declare i64 @glXCreatePbuffer(i8*, i8*, i32*) local_unnamed_addr #1

declare i32 @XFree(i8*) local_unnamed_addr #1

declare i32 @XSync(i8*, i32) local_unnamed_addr #1

declare i32 @glXMakeContextCurrent(i8*, i64, i64, i8*) local_unnamed_addr #1
