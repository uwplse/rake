...
define weak dso_local i8* @halide_default_get_symbol(i8* %0) #0 !dbg !36 {
  ...
  %2 = tail call i8* @dlsym(i8* nonnull inttoptr (i64 -2 to i8*), i8* %0) #4, !dbg !40
  ret i8* %2, !dbg !41
}
...
define weak dso_local i8* @halide_default_get_library_symbol(i8* %0, i8* %1) #0 !dbg !53 {
  ...
  %4 = select i1 %3, i8* inttoptr (i64 -2 to i8*), i8* %0, !dbg !60
...
define weak dso_local i8* (i8*)* @halide_set_custom_get_symbol(i8* (i8*)* %0) local_unnamed_addr #2 !dbg !63 {
  ...
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal17custom_get_symbolE, align 8, !dbg !70, !tbaa !71
  call void @llvm.dbg.value(metadata i8* (i8*)* %2, metadata !68, metadata !DIExpression()), !dbg !69
  store i8* (i8*)* %0, i8* (i8*)** @_ZN6Halide7Runtime8Internal17custom_get_symbolE, align 8, !dbg !75, !tbaa !71
  ret i8* (i8*)* %2, !dbg !76
}
...
define weak dso_local i8* (i8*)* @halide_set_custom_load_library(i8* (i8*)* %0) local_unnamed_addr #2 !dbg !77 {
  ...
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal19custom_load_libraryE, align 8, !dbg !84, !tbaa !71
  call void @llvm.dbg.value(metadata i8* (i8*)* %2, metadata !82, metadata !DIExpression()), !dbg !83
  store i8* (i8*)* %0, i8* (i8*)** @_ZN6Halide7Runtime8Internal19custom_load_libraryE, align 8, !dbg !85, !tbaa !71
  ret i8* (i8*)* %2, !dbg !86
}
...
define weak dso_local i8* (i8*, i8*)* @halide_set_custom_get_library_symbol(i8* (i8*, i8*)* %0) local_unnamed_addr #2 !dbg !87 {
  ...
  %2 = load i8* (i8*, i8*)*, i8* (i8*, i8*)** @_ZN6Halide7Runtime8Internal25custom_get_library_symbolE, align 8, !dbg !94, !tbaa !71
  call void @llvm.dbg.value(metadata i8* (i8*, i8*)* %2, metadata !92, metadata !DIExpression()), !dbg !93
  store i8* (i8*, i8*)* %0, i8* (i8*, i8*)** @_ZN6Halide7Runtime8Internal25custom_get_library_symbolE, align 8, !dbg !95, !tbaa !71
...
define weak dso_local i8* @halide_get_symbol(i8* %0) local_unnamed_addr #0 !dbg !97 {
  ...
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal17custom_get_symbolE, align 8, !dbg !101, !tbaa !71
...
define weak dso_local i8* @halide_load_library(i8* %0) local_unnamed_addr #0 !dbg !103 {
  ...
  %2 = load i8* (i8*)*, i8* (i8*)** @_ZN6Halide7Runtime8Internal19custom_load_libraryE, align 8, !dbg !107, !tbaa !71
...
define weak dso_local i8* @halide_get_library_symbol(i8* %0, i8* %1) local_unnamed_addr #0 !dbg !109 {
  ...
  %3 = load i8* (i8*, i8*)*, i8* (i8*, i8*)** @_ZN6Halide7Runtime8Internal25custom_get_library_symbolE, align 8, !dbg !114, !tbaa !71
