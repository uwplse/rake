; ModuleID = '/media/maaz/Data/Repos/rake/Halide-master-d48fbde/src/runtime/wasm_cpu_features.cpp'
source_filename = "/media/maaz/Data/Repos/rake/Halide-master-d48fbde/src/runtime/wasm_cpu_features.cpp"
...
define weak dso_local void @_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv(%"struct.Halide::Runtime::Internal::CpuFeatures"* noalias sret(%"struct.Halide::Runtime::Internal::CpuFeatures") align 8 %0) local_unnamed_addr #0 !dbg !119 {
  ...
  call void @llvm.dbg.value(metadata i32 0, metadata !129, metadata !DIExpression()), !dbg !135
  %2 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i32 0, i32 0, i32 0, !dbg !136
  %3 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i32 0, i32 1, i32 0, !dbg !139
  call void @llvm.dbg.value(metadata i32 1, metadata !129, metadata !DIExpression()), !dbg !135
  call void @llvm.dbg.value(metadata i32 1, metadata !129, metadata !DIExpression()), !dbg !135
  %4 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i32 0, i32 0, i32 1, !dbg !136
  store i64 0, i64* %4, align 8, !dbg !140, !tbaa !141
  %5 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i32 0, i32 1, i32 1, !dbg !139
  store i64 0, i64* %5, align 8, !dbg !145, !tbaa !141
  call void @llvm.dbg.value(metadata i32 2, metadata !129, metadata !DIExpression()), !dbg !135
  ...
  call void @llvm.dbg.value(metadata i32 61, metadata !149, metadata !DIExpression()), !dbg !150
  store i64 2305843009213693952, i64* %2, align 8, !dbg !152, !tbaa !141
  ...
  call void @llvm.dbg.value(metadata i32 61, metadata !156, metadata !DIExpression()), !dbg !157
  store i64 2305843009213693952, i64* %3, align 8, !dbg !159, !tbaa !141
  ret void, !dbg !160
}
...
!1 = !DIFile(filename: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde/src/runtime/wasm_cpu_features.cpp", directory: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde")
!2 = !{!3}
...
!120 = !DIFile(filename: "src/runtime/wasm_cpu_features.cpp", directory: "/media/maaz/Data/Repos/rake/Halide-master-d48fbde")
...
!132 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !84, size: 32)
...
!151 = distinct !DILocation(line: 15, column: 14, scope: !119)
...
!158 = distinct !DILocation(line: 16, column: 14, scope: !119)
!159 = !DILocation(line: 22, column: 27, scope: !154, inlinedAt: !158)
!160 = !DILocation(line: 18, column: 5, scope: !119)
