...
define weak dso_local void @halide_default_print(i8* %0, i8* %1) local_unnamed_addr #0 !dbg !13 {
  ...
  %4 = tail call i64 @write(i32 1, i8* %1, i64 %3) #3, !dbg !26
  ret void, !dbg !27
}

declare !dbg !28 dso_local i64 @write(i32, i8*, i64) local_unnamed_addr #1

declare !dbg !36 dso_local i64 @strlen(i8*) local_unnamed_addr #1
...
!36 = !DISubprogram(name: "strlen", scope: !8, file: !8, line: 92, type: !37, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !2)
