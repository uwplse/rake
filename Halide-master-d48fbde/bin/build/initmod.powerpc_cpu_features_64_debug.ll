...
define weak dso_local void @_ZN6Halide7Runtime8Internal23halide_get_cpu_featuresEv(%"struct.Halide::Runtime::Internal::CpuFeatures"* noalias sret(%"struct.Halide::Runtime::Internal::CpuFeatures") align 8 %0) local_unnamed_addr #0 !dbg !119 {
  ...
  call void @llvm.dbg.value(metadata i64 0, metadata !133, metadata !DIExpression()), !dbg !139
  %2 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i64 0, i32 0, i64 0, !dbg !140
  %3 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i64 0, i32 1, i64 0, !dbg !143
  store i64 0, i64* %3, align 8, !dbg !144, !tbaa !145
  call void @llvm.dbg.value(metadata i64 1, metadata !133, metadata !DIExpression()), !dbg !139
  call void @llvm.dbg.value(metadata i64 1, metadata !133, metadata !DIExpression()), !dbg !139
  %4 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i64 0, i32 0, i64 1, !dbg !140
  store i64 0, i64* %4, align 8, !dbg !149, !tbaa !145
  %5 = getelementptr inbounds %"struct.Halide::Runtime::Internal::CpuFeatures", %"struct.Halide::Runtime::Internal::CpuFeatures"* %0, i64 0, i32 1, i64 1, !dbg !143
  store i64 0, i64* %5, align 8, !dbg !144, !tbaa !145
  call void @llvm.dbg.value(metadata i64 2, metadata !133, metadata !DIExpression()), !dbg !139
  ...
  %6 = tail call i64 @getauxval(i64 16) #3, !dbg !159
  call void @llvm.dbg.value(metadata i64 %6, metadata !125, metadata !DIExpression()), !dbg !160
  %7 = tail call i64 @getauxval(i64 26) #3, !dbg !161
  call void @llvm.dbg.value(metadata i64 %7, metadata !128, metadata !DIExpression()), !dbg !160
  %8 = trunc i64 %6 to i8, !dbg !162
  %9 = icmp sgt i8 %8, -1, !dbg !162
  %10 = trunc i64 %7 to i32, !dbg !164
  %11 = icmp sgt i32 %10, -1, !dbg !164
  %12 = and i1 %9, %11, !dbg !166
  br i1 %12, label %16, label %13, !dbg !166

13:                                               ; preds = %1
  %14 = select i1 %9, i64 8192, i64 12288, !dbg !167
  %15 = select i1 %11, i64 4096, i64 %14, !dbg !168
  store i64 %15, i64* %3, align 8, !dbg !166, !tbaa !145
  br label %16, !dbg !166
...
declare !dbg !169 dso_local i64 @getauxval(i64) local_unnamed_addr #2
...
!136 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !84, size: 64)
...
!162 = !DILocation(line: 25, column: 9, scope: !163)
!163 = distinct !DILexicalBlock(scope: !119, file: !120, line: 25, column: 9)
!164 = !DILocation(line: 28, column: 9, scope: !165)
!165 = distinct !DILexicalBlock(scope: !119, file: !120, line: 28, column: 9)
!166 = !DILocation(line: 32, column: 1, scope: !119)
!167 = !DILocation(line: 25, column: 9, scope: !119)
!168 = !DILocation(line: 28, column: 9, scope: !119)
!169 = !DISubprogram(name: "getauxval", scope: !120, file: !120, line: 11, type: !170, flags: DIFlagPrototyped, spFlags: DISPFlagOptimized, retainedNodes: !172)
