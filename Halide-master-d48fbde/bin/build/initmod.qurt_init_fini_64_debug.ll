...
@__DTOR_LIST__ = external dso_local local_unnamed_addr global i64, align 8
@__CTOR_END__ = external dso_local local_unnamed_addr global i64, align 8

; Function Attrs: nounwind
define dso_local void @run_dtors() local_unnamed_addr #0 section ".fini.halide" !dbg !6 {
  call void @llvm.dbg.value(metadata i64* @__DTOR_LIST__, metadata !10, metadata !DIExpression()), !dbg !34
  %1 = load i64, i64* @__DTOR_LIST__, align 8, !dbg !35, !tbaa !36
  call void @llvm.dbg.value(metadata i64 %1, metadata !16, metadata !DIExpression()), !dbg !40
  %2 = icmp eq i64 %1, 0, !dbg !41
  br i1 %2, label %10, label %3, !dbg !43

3:                                                ; preds = %0, %3
  %4 = phi i64 [ %8, %3 ], [ %1, %0 ]
  %5 = phi i64* [ %7, %3 ], [ @__DTOR_LIST__, %0 ]
  call void @llvm.dbg.value(metadata i64* %5, metadata !10, metadata !DIExpression()), !dbg !34
  %6 = inttoptr i64 %4 to void ()*, !dbg !44
  call void @llvm.dbg.value(metadata void ()* %6, metadata !16, metadata !DIExpression()), !dbg !40
  tail call void %6() #2, !dbg !45
  %7 = getelementptr inbounds i64, i64* %5, i64 1, !dbg !47
  call void @llvm.dbg.value(metadata i64* %7, metadata !10, metadata !DIExpression()), !dbg !34
  %8 = load i64, i64* %7, align 8, !dbg !35, !tbaa !36
  call void @llvm.dbg.value(metadata i64 %8, metadata !16, metadata !DIExpression()), !dbg !40
  %9 = icmp eq i64 %8, 0, !dbg !41
...
define dso_local void @run_ctors() local_unnamed_addr #0 section ".init.halide" !dbg !20 {
  call void @llvm.dbg.value(metadata i64* @__CTOR_END__, metadata !22, metadata !DIExpression()), !dbg !49
  call void @llvm.dbg.value(metadata i64* getelementptr (i64, i64* @__CTOR_END__, i64 -1), metadata !22, metadata !DIExpression()), !dbg !49
  %1 = load i64, i64* getelementptr (i64, i64* @__CTOR_END__, i64 -1), align 8, !dbg !50, !tbaa !36
  call void @llvm.dbg.value(metadata i64 %1, metadata !23, metadata !DIExpression()), !dbg !51
  %2 = icmp eq i64 %1, 0, !dbg !52
  br i1 %2, label %10, label %3, !dbg !54

3:                                                ; preds = %0, %3
  %4 = phi i64 [ %8, %3 ], [ %1, %0 ]
  %5 = phi i64* [ %7, %3 ], [ getelementptr (i64, i64* @__CTOR_END__, i64 -1), %0 ]
  %6 = inttoptr i64 %4 to void ()*, !dbg !55
  call void @llvm.dbg.value(metadata void ()* %6, metadata !23, metadata !DIExpression()), !dbg !51
  tail call void %6() #2, !dbg !56
  call void @llvm.dbg.value(metadata i64* %5, metadata !22, metadata !DIExpression()), !dbg !49
  %7 = getelementptr inbounds i64, i64* %5, i64 -1, !dbg !58
  call void @llvm.dbg.value(metadata i64* %7, metadata !22, metadata !DIExpression()), !dbg !49
  %8 = load i64, i64* %7, align 8, !dbg !50, !tbaa !36
  call void @llvm.dbg.value(metadata i64 %8, metadata !23, metadata !DIExpression()), !dbg !51
...
!12 = !DIDerivedType(tag: DW_TAG_typedef, name: "addr_t", file: !5, line: 4, baseType: !13)
!13 = !DIDerivedType(tag: DW_TAG_typedef, name: "uint64_t", file: !14, line: 10, baseType: !15)
