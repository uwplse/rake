...
declare dso_local i32 @halide_cuda_get_device_ptr(i8*, %struct.halide_buffer_t*) #0
...
declare dso_local i32 @halide_cuda_run(i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32*, i8**, i8*, i32, float*, i32, i32) #0
...
declare dso_local i8* @halide_malloc(i8*, i32) #0
...
declare dso_local i32 @halide_metal_get_buffer(i8*, %struct.halide_buffer_t*) #0
...
declare dso_local i32 @halide_metal_run(i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32*, i8**, i8*, i32, float*, i32, i32) #0
...
declare dso_local i32 @halide_opencl_get_cl_mem(i8*, %struct.halide_buffer_t*) #0
...
declare dso_local i32 @halide_opencl_run(i8*, i8*, i8*, i32, i32, i32, i32, i32, i32, i32, i32*, i8**, i8*, i32, float*, i32, i32) #0
...
declare dso_local i8* (i8*, i32)* @halide_set_custom_malloc(i8* (i8*, i32)*) #0
...
!13 = !DICompositeType(tag: DW_TAG_array_type, baseType: !14, size: 5952, elements: !15)
