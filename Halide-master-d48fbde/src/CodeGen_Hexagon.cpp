...
void CodeGen_Hexagon::compile_func(const LoweredFunc &f,
...
#if 0
    debug(1) << "Optimizing Hexagon instructions (legacy)...\n";
    body = optimize_hexagon_instructions_legacy(body, target);
#else
    ...
    body = common_subexpression_elimination(simplify(body));
#endif
